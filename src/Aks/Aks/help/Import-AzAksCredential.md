...
PS C:> Import-AzAksCredential -Force  -Name myCluster -ResourceGroupName group
```

Import and merge Kubectl config for a managed Kubernetes Cluster. (autogenerated)
