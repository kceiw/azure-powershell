...
Create a new node pool in specified cluster. (autogenerated)

<!-- Aladdin Generated Example -->
```powershell
New-AzAksNodePool -ClusterName myCluster -Count <Int32> -EnableAutoScaling -KubernetesVersion <String> -MaxCount <Int32> -MinCount 5 -Name mydefault -OsType Windows -ResourceGroupName myResouceGroup -VmSize <String>
```
