...
```powershell
New-AzAksNodePool -ClusterName myCluster -Count <Int32> -Name mydefault -OsDiskSize <Int32> -OsType Windows -ResourceGroupName myResouceGroup -VmSetType VirtualMachineScaleSets
```
