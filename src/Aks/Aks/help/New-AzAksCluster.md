...
### Example 1: New an AKS with default params.
...
```powershell
New-AzAksCluster -DnsNamePrefix <String> -KubernetesVersion <String> -Location westus -Name myCluster -ResourceGroupName myresourcegroup
```
