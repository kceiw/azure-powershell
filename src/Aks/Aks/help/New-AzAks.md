...
PS C:> New-AzAks -ClientIdAndSecret {ClientIdAndSecret} -KubernetesVersion {KubernetesVersion} -Location westus -Name myCluster -NodeCount {NodeCount} -NodeVmSize {NodeVmSize} -ResourceGroupName group
```
