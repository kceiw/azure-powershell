...
Retrieves a list of credentials associated with an application. (autogenerated)

<!-- Aladdin Generated Example -->
```powershell
Get-AzADAppCredential -ApplicationId 00000000-0000-0000-0000-00000000000000000
```
