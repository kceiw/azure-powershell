...
Lists all Azure RBAC roles that are available for assignment in this powershell session. (autogenerated)

<!-- Aladdin Generated Example -->
```powershell
Get-AzRoleDefinition -Scope '/subscriptions/00000000-0000-0000-0000-00000000000000000/resourcegroups/testRG/providers/Microsoft.Web/sites/site1'
```
