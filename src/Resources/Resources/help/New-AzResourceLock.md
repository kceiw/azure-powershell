...
PS C:> New-AzResourceLock -Force  -LockLevel CanNotDelete -LockName ContosoSiteLock -LockNotes My lock notes -ResourceGroupName MyResourceGroup -ResourceName ContosoSite -ResourceType microsoft.web/sites
```

The New-AzResourceLock cmdlet creates a resource lock. (autogenerated)
