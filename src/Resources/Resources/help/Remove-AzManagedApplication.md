...
PS C:> Remove-AzManagedApplication -Name Deploy01 -ResourceGroupName MyResourceGroup
```

The Remove-AzManagedApplication cmdlet removes a managed application. (autogenerated)
