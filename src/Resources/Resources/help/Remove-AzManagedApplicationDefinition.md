...
PS C:> Remove-AzManagedApplicationDefinition -Force  -Name Deploy01 -ResourceGroupName MyResourceGroup
```

The Remove-AzManagedApplicationDefinition cmdlet removes a managed application definition. (autogenerated)
