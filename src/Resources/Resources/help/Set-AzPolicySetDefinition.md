...
PS C:> Set-AzPolicySetDefinition -Description Updated policy to not allow virtual machine creation -DisplayName MyNewDisplayName -ManagementGroupName Dept42 -Metadata {"category":"Virtual Machine"} -Name VMPolicySetDefinition -PolicyDefinition $Policy
```

The Set-AzPolicySetDefinition cmdlet modifies a policy definition. (autogenerated)
