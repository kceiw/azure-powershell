...
PS C:> New-AzPolicySetDefinition -Description sample description -DisplayName MyNewDisplayName -ManagementGroupName Dept42 -Name VMPolicySetDefinition -Parameter { "buTagValue": { "type": "string" } } -PolicyDefinition C:VMPolicySet.json
```

The New-AzPolicySetDefinition cmdlet creates a policy set definition. (autogenerated)
