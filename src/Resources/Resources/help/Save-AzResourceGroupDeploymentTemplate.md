...
PS C:> Save-AzResourceGroupDeploymentTemplate -DeploymentName TestDeployment -Force  -ResourceGroupName TestGroup
```

The Save-AzResourceGroupDeploymentTemplate  cmdlet saves a resource group deployment template to a JSON file. (autogenerated)
