...
Creates a new azure active directory application and associates password credentials with it. (autogenerated)

<!-- Aladdin Generated Example -->
```powershell
New-AzADApplication -DisplayName 'NewApplication' -HomePage 'https://www.microsoft.com' -IdentifierUris 'https://NewApplication' -Password <SecureString>
```
