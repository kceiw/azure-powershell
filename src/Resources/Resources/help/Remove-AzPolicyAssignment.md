...
PS C:> Remove-AzPolicyAssignment -Id $PolicyAssignment.ResourceId
```

The Remove-AzPolicyAssignment cmdlet removes the specified policy assignment. (autogenerated)
