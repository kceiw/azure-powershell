...
Validates a deployment at tenant scope. (autogenerated)

<!-- Aladdin Generated Example -->
```powershell
Test-AzTenantDeployment -Location 'West US' -TemplateParameterFile 'D:\Azure\Templates\EngSiteParams.json' -TemplateUri <String>
```
