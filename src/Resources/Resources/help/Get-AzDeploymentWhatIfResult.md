...
Gets a template What-If result for a deployment at subscription scope. (autogenerated)

<!-- Aladdin Generated Example -->
```powershell
Get-AzDeploymentWhatIfResult -Location 'West US' -Name 'deploy-01' -SkipTemplateParameterPrompt -TemplateFile 'D:\Azure\Templates\ServiceTemplate.json' -TemplateParameterObject <Hashtable>
```
