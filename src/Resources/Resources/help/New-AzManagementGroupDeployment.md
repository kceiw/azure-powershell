...
Create a deployment at a management group. (autogenerated)

<!-- Aladdin Generated Example -->
```powershell
New-AzManagementGroupDeployment -DeploymentDebugLogLevel RequestContent -Location 'West US' -ManagementGroupId 'myMG' -Name 'Deploy01' -TemplateFile 'D:\Azure\Templates\OrgSetup.json' -TemplateParameterFile 'D:\Azure\Templates\OrgParams.json'
```
