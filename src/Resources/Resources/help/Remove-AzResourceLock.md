...
PS C:> Remove-AzResourceLock -Force  -LockName ContosoSiteLock -ResourceGroupName MyResourceGroup -ResourceName /subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/Default-Storage-SouthCentralUS/providers/Microsoft.ClassicStorage/storageAccounts/mystorageaccount/providers/Microsoft.Authorization/locks/test -ResourceType Microsoft.ClassicCompute/storageAccounts
```

The Remove-AzResourceLock cmdlet removes an Azure resource lock. (autogenerated)
