...
### Example 1: 1.1 - Namespace with InputObject
```powershell
PS C:\>
...
### Example 2: 1.2 - Namespace with Rights parameter
```powershell
...
### Example 3: 2.1 - WcfRelay with InputObject
```powershell
...
### Example 4: 2.2 - WcfRelay with Rights parameter
```powershell
...
### Example 5: 3.1 - HybridConnection with InputObject
```powershell
...
### Example 6: 3.2 - HybridConnection with Rights parameter
```powershell
