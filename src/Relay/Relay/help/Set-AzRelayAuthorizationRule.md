...
### Example 2.2 - Namespace with Rights parameter
```powershell
...
### Example 3.1 - WcfRelay with InputObject
```powershell
...
### Example 4.2 - WcfRelay with Rights parameter
```powershell
...
### Example 5.1 - HybridConnection with InputObject
```powershell
...
### Example 6.2 - HybridConnection with Rights parameter
```powershell
