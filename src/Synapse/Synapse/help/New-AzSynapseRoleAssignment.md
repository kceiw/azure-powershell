...
Creates a Synapse Analytics role assignment. (autogenerated)

<!-- Aladdin Generated Example -->
```powershell
New-AzSynapseRoleAssignment -ObjectId '00000000-0000-0000-0000-00000000000000000' -RoleDefinitionName ContosoRole -WorkspaceName ContosoWorkspace
```
