...
Creates a Synapse Analytics SQL pool. (autogenerated)

<!-- Aladdin Generated Example -->
```powershell
New-AzSynapseSqlPool -Name ContosoSqlPool -PerformanceLevel DW200c -ResourceGroupName myresourcegroup -Version <Int32> -WorkspaceName ContosoWorkspace
```
