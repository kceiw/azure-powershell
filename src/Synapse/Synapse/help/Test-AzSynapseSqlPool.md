...
Checks for the existence of a Synapse Analytics SQL pool. (autogenerated)

<!-- Aladdin Generated Example -->
```powershell
Test-AzSynapseSqlPool -Name ContosoSqlPool -ResourceGroupName myresourcegroup -Version <Int32> -WorkspaceName ContosoWorkspace
```
