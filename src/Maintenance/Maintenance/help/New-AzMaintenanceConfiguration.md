...
Create or Update configuration record. (autogenerated)

<!-- Aladdin Generated Example -->
```powershell
New-AzMaintenanceConfiguration -Duration 05:00 -Location centralus -MaintenanceScope Host -Name workervmscentralus -RecurEvery Day -ResourceGroupName smdtest -StartDateTime 2020-08-01 -Timezone Pacific
```
