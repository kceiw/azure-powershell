...
PS C:> Stop-AzLogicAppRun -Name LogicApp03 -ResourceGroupName ResourceGroup11 -RunName 08587489104702792076
```

The Stop-AzLogicAppRun cmdlet cancels a run of a logic app (autogenerated)
