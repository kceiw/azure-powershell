...
PS C:> Set-AzIntegrationAccountCertificate -CertificateName IntegrationAccountCertificate01 -Force  -Name IntegrationAccount31 -PublicCertificateFilePath c:\temp\Certificate.cer -ResourceGroupName ResourceGroup11
```

The Set-AzIntegrationAccountCertificate cmdlet modifies an integration account certificate (autogenerated)
