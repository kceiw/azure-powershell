...
Creates an integration account schema. (autogenerated)

<!-- Aladdin Generated Example -->
```powershell
New-AzIntegrationAccountSchema -Name 'IntegrationAccount31' -ResourceGroupName 'ResourceGroup11' -SchemaFilePath 'c:\temp\schema1' -SchemaName 'IntegrationAccountSchema1' -SchemaType Xml
```
