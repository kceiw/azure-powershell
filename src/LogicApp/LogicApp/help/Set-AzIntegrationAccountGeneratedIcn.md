...
## DESCRIPTION
The Set-AzIntegrationAccountGeneratedIcn cmdlet updates an existing integration account generated interchange control number (ICN) and returns an object that represents the integration account generated interchange control number.
...
This command gets the integration account generated X12 interchange control number for a specific integration account agreement, increase its value by 100 then writes back the updated value. (autogenerated)

<!-- Aladdin Generated Example -->
```powershell
Set-AzIntegrationAccountGeneratedIcn -AgreementName 'EdifactIntegrationAccountAgreement' -AgreementType X12 -ControlNumber '123' -Name 'IntegrationAccount1' -ResourceGroupName 'ResourceGroup1'
```
