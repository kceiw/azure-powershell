...
PS C:> Set-AzIntegrationAccountSchema -ContentType {ContentType} -Force  -Name IntegrationAccount31 -ResourceGroupName ResourceGroup11 -SchemaFilePath c:\temp\schema1 -SchemaName IntegrationAccountSchema43 -SchemaType Xml
```

The Set-AzIntegrationAccountSchema cmdlet modifies an integration account schema (autogenerated)
