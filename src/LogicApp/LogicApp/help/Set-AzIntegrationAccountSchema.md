...
Modifies an integration account schema. (autogenerated)

<!-- Aladdin Generated Example -->
```powershell
Set-AzIntegrationAccountSchema -Name 'IntegrationAccount31' -ResourceGroupName 'ResourceGroup11' -SchemaFilePath 'c:\temp\schema1' -SchemaName 'IntegrationAccountSchema43' -SchemaType Xml
```
