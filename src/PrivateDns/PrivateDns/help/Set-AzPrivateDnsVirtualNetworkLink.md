...
PS C:> Set-AzPrivateDnsVirtualNetworkLink -Tag @{}
```

The Set-AzPrivateDnsVirtualNetworkLink cmdlet updates a link associated with a zone from a specified resource group (autogenerated)
