...
Deletes a record set from a Private DNS zone. (autogenerated)

<!-- Aladdin Generated Example -->
```powershell
Remove-AzPrivateDnsRecordSet -Name 'www' -RecordType A -ResourceGroupName 'MyResourceGroup' -ZoneName 'myzone.com'
```
