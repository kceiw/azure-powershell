...
PS C:> Restore-AzDataLakeStoreDeletedItem -Account ContosoADL -Destination C:\Test.csv -Force  -Path /abc/myFile.txt -Type User
```

The Restore-AzDataLakeStoreDeletedItem cmdlet restores a deleted file or folder in Data Lake Store (autogenerated)
