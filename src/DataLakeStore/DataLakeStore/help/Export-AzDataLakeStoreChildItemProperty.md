...
## DESCRIPTION
The **Export-AzDataLakeStoreChildItemProperty** is used to report the ADLS space usage or/and ACL usage for the given directory and it's sub directories and files.
...
PS C:> Export-AzDataLakeStoreChildItemProperty -Account ContosoADL -Concurrency 4 -GetDiskUsage  -MaximumDepth {MaximumDepth} -OutputPath C:\Users\contoso\Desktop\DumpFile.txt -Path /a
```

The Export-AzDataLakeStoreChildItemProperty is used to report the ADLS space usage or/and ACL usage for the given directory and it's sub directories and files. (autogenerated)
