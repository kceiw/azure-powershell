...
Exports the properties (Disk usage and Acl) for the entire tree from the specified path to a output path. (autogenerated)

<!-- Aladdin Generated Example -->
```powershell
Export-AzDataLakeStoreChildItemProperty -Account ContosoADL -Concurrency 4 -GetAcl -GetDiskUsage -IncludeFile -OutputPath 'C:\Users\contoso\Desktop\DumpFile.txt' -Path /a
```
