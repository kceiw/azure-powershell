...
```powershell
Export-AzDataLakeStoreChildItemProperty -Account ContosoADL -GetDiskUsage -IncludeFile -MaximumDepth <Int32> -OutputPath 'C:\Users\contoso\Desktop\DumpFile.txt' -Path /a
```
