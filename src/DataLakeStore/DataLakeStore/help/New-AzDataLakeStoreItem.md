...
Creates a new file or folder in Data Lake Store. (autogenerated)

<!-- Aladdin Generated Example -->
```powershell
New-AzDataLakeStoreItem -Account 'ContosoADL' -Encoding <Encoding> -Path '/NewFile.txt' -Value 'My content here'
```
