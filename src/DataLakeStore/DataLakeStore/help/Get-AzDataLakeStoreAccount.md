...
PS C:> Get-AzDataLakeStoreAccount -Name ContosoADL -ResourceGroupName MyResourceGroup
```

The Get-AzDataLakeStoreAccount cmdlet gets details of a Data Lake Store account. (autogenerated)
