...
PS C:> Get-AzPrivateEndpointConnection -ResourceId $id
```

The Get-AzPrivateEndpointConnection cmdlet retrieves a private endpoint connection resource. (autogenerated)
