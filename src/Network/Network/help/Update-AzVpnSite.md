...
PS C:> Update-AzVpnSite -AddressSpace $vpnSiteAddressSpaces -Name cert01 -ResourceGroupName MyResourceGroup -Tag $tag
```

The Update-AzVpnSite cmdlet updates a VPN site. (autogenerated)
