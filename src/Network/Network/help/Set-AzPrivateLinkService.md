...
### Example 1: 1: Creates a private link service and update its
```powershell
...
PS C:> Set-AzPrivateLinkService -PrivateLinkService <PSPrivateLinkService>
```

The Set-AzPrivateLinkService cmdlet updates a private link service. (autogenerated)
