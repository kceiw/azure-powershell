...
PS C:> New-AzVpnConnection -Name testConnection -ParentResourceName $vpnGateway.Name -ResourceGroupName $vpnGateway.ResourceGroupName -SharedKey $Secure_String_Pwd -VpnSiteId <String>
```
