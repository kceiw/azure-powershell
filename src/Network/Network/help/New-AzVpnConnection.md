...
PS C:> New-AzVpnConnection -ConnectionBandwidthInMbps 20 -Name testConnection -ParentResourceName $vpnGateway.Name -ResourceGroupName $vpnGateway.ResourceGroupName -SharedKey $Secure_String_Pwd -VpnConnectionProtocolType IKEv1 -VpnSiteId <String>
```

Creates a IPSec connection that connects a VpnGateway to a remote customer branch represented in RM as a VpnSite. (autogenerated)
