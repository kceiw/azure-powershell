...
PS C:> Get-AzVirtualNetworkPeering -Name myVnet1To* -ResourceGroupName ResourceGroup -VirtualNetworkName myVnet
```

The Get-AzVirtualNetworkPeering cmdlet gets the virtual network peering. (autogenerated)
