...
PS C:> Add-AzLoadBalancerBackendAddressPoolConfig -Confirm  -Name cert01
```

The Add-AzLoadBalancerBackend cmdlet adds a backend address pool to an Azure load balancer. (autogenerated)
