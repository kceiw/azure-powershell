...
PS C:> Set-AzApplicationGatewayFirewallPolicy -InputObject $bastion
```

The Set-AzApplicationGatewayFirewallPolicy cmdlet updates an Azure application gateway firewall policy. (autogenerated)
