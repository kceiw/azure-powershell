...
## DESCRIPTION
The **Remove-AzLoadBalancerOutboundRuleConfig** cmdlet removes an outbound rule configuration from an Azure load balancer.
...
PS C:> Remove-AzLoadBalancerOutboundRuleConfig -Confirm  -Name RuleName
```

The Remove-AzLoadBalancerOutboundRuleConfig cmdlet removes an outbound rule configuration from an Azure load balancer. (autogenerated)
