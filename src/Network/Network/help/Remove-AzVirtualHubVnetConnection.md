...
PS C:> Remove-AzVirtualHubVnetConnection -Force  -InputObject $bastion
```

The Remove-AzVirtualHubVnetConnection cmdlet removes an Azure Virtual Network Connection which peers a remote VNET to the hub VNET. (autogenerated)
