...
Creates an Azure express route circuit. (autogenerated)

<!-- Aladdin Generated Example -->
```powershell
New-AzExpressRouteCircuit -BandwidthInGbps <Double> -ExpressRoutePort <PSExpressRoutePort> -Location 'West Central US' -Name 'testExpressRouteCircuit' -ResourceGroupName 'testRG' -SkuFamily MeteredData -SkuTier Standard
```
