...
## DESCRIPTION
The **Get-AzVpnClientPackage** cmdlet gets information about the VPN client packages available from a virtual network gateway.
...
You must specify the architecture type when running **Get-AzVpnClientPackage**.
