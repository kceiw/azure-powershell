...
PS C:> Set-AzLoadBalancerProbeConfig -IntervalInSeconds 15 -LoadBalancer $loadbalancer -Name NewProbe -Port 80 -ProbeCount 2
```

The Set-AzLoadBalancerProbeConfig cmdlet updates a probe configuration for a load balancer. (autogenerated)
