...
### Example 1: 1:  Create a rule for all TCP traffic
```powershell
...
### Example 2: 2:  Create a rule for all TCP traffic from 10.0.0.0 to 60.1.5.0:4040
```powershell
...
### Example 3: 3: Create a rule for all TCP and ICMP traffic from any source to 10.0.0.0/16
```powershell
