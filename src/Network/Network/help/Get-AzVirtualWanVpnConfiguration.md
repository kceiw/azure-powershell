...
PS C:> Get-AzVirtualWanVpnConfiguration -Name cert01 -ResourceGroupName MyResourceGroup -StorageSasUrl SignedSasUrl -VpnSite $vpnSite
```

Gets the Vpn configuration for a subset of VpnSites connected to this WAN via VpnConnections (autogenerated)
