...
Gets a network level view of resources and their relationships in a resource group. (autogenerated)

<!-- Aladdin Generated Example -->
```powershell
Get-AzNetworkWatcherTopology -NetworkWatcherName nw1 -ResourceGroupName testresourcegroup -TargetResourceGroupName <String>
```
