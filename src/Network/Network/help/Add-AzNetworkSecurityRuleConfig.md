...
Adds a network security rule configuration to a network security group. (autogenerated)

<!-- Aladdin Generated Example -->
```powershell
Add-AzNetworkSecurityRuleConfig -Access Allow -Description 'Allow RDP' -DestinationAddressPrefix * -DestinationPortRange 3389 -Direction Inbound -Name rdp-rule -Priority 100 -Protocol Tcp -SourceAddressPrefix 'Internet' -SourcePortRange * -NetworkSecurityGroup <PSNetworkSecurityGroup>
```
