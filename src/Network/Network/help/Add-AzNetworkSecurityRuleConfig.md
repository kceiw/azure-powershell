...
### Example 1: 1: Adding a network security group
```powershell
...
### Example 2: 2: Adding a new security rule with application security groups
```powershell
...
The Add-AzNetworkSecurityRuleConfig cmdlet adds a network security rule configuration to an Azure network security group. (autogenerated)
