...
PS C:> New-AzExpressRouteGateway -MaxScaleUnits <UInt32> -MinScaleUnits 2 -Name testExpressRoutegw -ResourceGroupName testRG -Tag $tag -VirtualHubId $virtualHub.Id
```

New-AzExpressRouteGateway creates a scalable ExpressRoute Gateway (autogenerated)
