...
View the configured and effective network security group rules applied on a VM. (autogenerated)

<!-- Aladdin Generated Example -->
```powershell
Get-AzNetworkWatcherSecurityGroupView -NetworkWatcherName nw1 -ResourceGroupName myresourcegroup -TargetVirtualMachineId <String>
```
