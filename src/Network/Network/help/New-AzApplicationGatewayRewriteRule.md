...
PS C:> New-AzApplicationGatewayRewriteRule -ActionSet $action -Name rule1 -RuleSequence 101
```

The New-AzApplicationGatewayRewriteRule cmdlet creates a rewrite rule for an Azure application gateway. (autogenerated)
