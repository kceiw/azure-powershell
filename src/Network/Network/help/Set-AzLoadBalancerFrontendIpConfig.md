...
PS C:> Set-AzLoadBalancerFrontendIpConfig -Name NewFrontend -PrivateIpAddress 10.0.0.5 -SubnetId /subscriptions/xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx/resourceGroups/ResourceGroup1/providers/Microsoft.Network/virtualNetworks/VirtualNetwork1/subnets/Subnet1
```

The Set-AzLoadBalancerFrontendIpConfig cmdlet updates a front-end IP configuration for a load balancer. (autogenerated)
