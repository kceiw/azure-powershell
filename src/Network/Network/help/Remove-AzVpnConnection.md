...
PS C:> Remove-AzVpnConnection -Force  -Name testConnection -ParentResourceName $vpnGateway.Name -ResourceGroupName $vpnGateway.ResourceGroupName
```

Removes a VpnConnection. (autogenerated)
