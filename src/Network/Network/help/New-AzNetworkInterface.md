...
PS C:> New-AzNetworkInterface -Location West US -Name $NicName -NetworkSecurityGroupId {NetworkSecurityGroupId} -PublicIpAddressId $PIP.Id -ResourceGroupName MyResourceGroup -SubnetId /subscriptions/xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx/resourceGroups/ResourceGroup1/providers/Microsoft.Network/virtualNetworks/VirtualNetwork1/subnets/Subnet1
```

The New-AzNetworkInterface cmdlet creates an Azure network interface. (autogenerated)
