...
### Example 1: 1:  Create a virtual network with two subnets and a network security group
```powershell
...
PS C:> New-AzVirtualNetworkSubnetConfig -AddressPrefix 10.0.0.0/24 -Name $subnetName -NetworkSecurityGroup $networkSecurityGroup
```

The New-AzVirtualNetworkSubnetConfig cmdlet creates a virtual network subnet configuration. (autogenerated)
