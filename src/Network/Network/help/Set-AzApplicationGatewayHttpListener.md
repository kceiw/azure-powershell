...
PS C:> Set-AzApplicationGatewayHttpListener -ApplicationGateway $AppGw -FrontendIPConfiguration {FrontendIPConfiguration} -FrontendPort $FP01 -HostName contoso.com -Name Listener01 -Protocol Http -SslCertificate $SSLCert01
```

The Set-AzApplicationGatewayHttpListener cmdlet modifies an HTTP listener for an Azure application gateway. (autogenerated)
