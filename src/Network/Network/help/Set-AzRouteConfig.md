...
Updates a route configuration for a route table. (autogenerated)

<!-- Aladdin Generated Example -->
```powershell
Set-AzRouteConfig -AddressPrefix <String> -Name 'cert01' -NextHopIpAddress '12.0.0.5' -NextHopType 'VnetLocal' -RouteTable <PSRouteTable>
```
