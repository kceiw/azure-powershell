...
Deletes the specified flow log resource. (autogenerated)

<!-- Aladdin Generated Example -->
```powershell
Remove-AzNetworkWatcherFlowLog -Name pstest -NetworkWatcherName nw1 -ResourceGroupName myresourcegroup
```
