...
PS C:> Remove-AzNetworkSecurityGroup -Force  -Name NSG-FrontEnd -ResourceGroupName TestRG
```

The Remove-AzNetworkSecurityGroup cmdlet removes an Azure network security group. (autogenerated)
