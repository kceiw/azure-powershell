...
PS C:> New-AzExpressRouteConnection -AuthorizationKey $circuit_peer.Authorizations[0].AuthorizationKey -ExpressRouteCircuitPeeringId $ExpressRouteCircuitPeeringId -ExpressRouteGatewayName <String> -Name testConnection -ResourceGroupName $ExpressRouteGateway.ResourceGroupName
```

Creates an ExpressRoute connection between an on-premise ExpressRoute circuit BGP peering to the ExpressRoute gateway inside a Virtual hub. (autogenerated)
