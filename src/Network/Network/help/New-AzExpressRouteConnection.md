...
PS C:> New-AzExpressRouteConnection -ExpressRouteCircuitPeeringId $ExpressRouteCircuitPeeringId -ExpressRouteGatewayName <String> -Name testConnection -ResourceGroupName $ExpressRouteGateway.ResourceGroupName
```
