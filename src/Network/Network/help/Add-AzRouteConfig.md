...
Adds a route to a route table. (autogenerated)

<!-- Aladdin Generated Example -->
```powershell
Add-AzRouteConfig -AddressPrefix 10.3.0.0/16 -Name 'Route13' -NextHopIpAddress '12.0.0.5' -NextHopType 'VnetLocal' -RouteTable <PSRouteTable>
```
