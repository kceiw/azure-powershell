...
PS C:> Add-AzRouteConfig -AddressPrefix 10.3.0.0/16 -Name Route13 -NextHopIpAddress 12.0.0.5 -NextHopType VnetLocal -RouteTable $RouteTable
```

The Add-AzRouteConfig cmdlet adds a route to an Azure route table. (autogenerated)
