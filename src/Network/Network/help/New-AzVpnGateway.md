...
Creates a Scalable VPN Gateway. (autogenerated)

<!-- Aladdin Generated Example -->
```powershell
New-AzVpnGateway -Name 'testvpngw' -ResourceGroupName 'testRG' -Tag '/Sql' -VirtualHub <PSVirtualHub> -VpnGatewayScaleUnit 2
```
