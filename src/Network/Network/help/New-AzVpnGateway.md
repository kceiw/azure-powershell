...
PS C:> New-AzVpnGateway -Name testvpngw -ResourceGroupName testRG -Tag $tag -VirtualHubName <String> -VpnGatewayScaleUnit 2
```

New-AzVpnGateway creates a scalable VPN Gateway (autogenerated)
