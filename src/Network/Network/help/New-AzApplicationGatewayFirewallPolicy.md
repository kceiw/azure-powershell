...
```powershell
New-AzApplicationGatewayFirewallPolicy -Location 'westus' -ManagedRule <PSApplicationGatewayFirewallPolicyManagedRules> -Name wafResource1 -PolicySetting <PSApplicationGatewayFirewallPolicySettings> -ResourceGroupName 'rg1'
```
