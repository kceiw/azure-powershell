...
PS C:> New-AzVirtualWan -Location Central US -Name MyVirtualWan -ResourceGroupName TestResourceGroup -Tag $tag
```

Creates a new Azure VirtualWAN resource. (autogenerated)
