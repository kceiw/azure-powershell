...
Adds a probe configuration to a load balancer. (autogenerated)

<!-- Aladdin Generated Example -->
```powershell
Add-AzLoadBalancerProbeConfig -IntervalInSeconds 15 -Name 'NewProbe' -Port 80 -ProbeCount 2 -Protocol 'https' -RequestPath 'healthcheck.aspx' -LoadBalancer <PSLoadBalancer>
```
