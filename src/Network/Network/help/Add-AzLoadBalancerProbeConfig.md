...
PS C:> Add-AzLoadBalancerProbeConfig -IntervalInSeconds 15 -LoadBalancer $loadbalancer -Name NewProbe -Port 80 -ProbeCount 2 -Protocol http
```

The Add-AzLoadBalancerProbeConfig cmdlet adds a probe configuration to an Azure load balancer. (autogenerated)
