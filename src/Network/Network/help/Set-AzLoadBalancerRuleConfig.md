...
Updates a rule configuration for a load balancer. (autogenerated)

<!-- Aladdin Generated Example -->
```powershell
Set-AzLoadBalancerRuleConfig -BackendAddressPool <PSBackendAddressPool> -BackendPort 3350 -DisableOutboundSNAT -FrontendIpConfiguration <PSFrontendIPConfiguration> -FrontendPort 3350 -Name 'NewRule' -Protocol 'Tcp' -LoadBalancer <PSLoadBalancer>
```
