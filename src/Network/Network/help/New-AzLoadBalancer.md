...
PS C:> New-AzLoadBalancer -BackendAddressPool $BackendAddressPool -FrontendIpConfiguration $Frontend -InboundNatPool {InboundNatPool} -LoadBalancingRule $lbrule -Location $LOC -Name $LBName -ResourceGroupName $RGName
```
