...
PS C:> New-AzApplicationGatewayAutoscaleConfiguration -MaxCapacity {MaxCapacity} -MinCapacity 3
```

The New-AzApplicationGatewayAutoscaleConfiguration cmdlet creates Autoscale Configuration for an Azure application gateway. (autogenerated)
