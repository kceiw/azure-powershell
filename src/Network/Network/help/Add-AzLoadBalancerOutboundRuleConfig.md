...
PS C:> Add-AzLoadBalancerOutboundRuleConfig -BackendAddressPool $slb.BackendAddressPools[0] -Confirm  -FrontendIpConfiguration $slb.FrontendIpConfigurations[0] -Name NewRule -Protocol Tcp
```

The Add-AzLoadBalancerOutboundRuleConfig cmdlet adds an outbound rule configuration to an Azure load balancer. (autogenerated)
