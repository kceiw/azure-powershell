...
### Example 1: 1: Creating a rule configuration for an Azure Load Balancer
```powershell
...
PS C:> New-AzLoadBalancerRuleConfig -BackendAddressPool $backendAddressPool -BackendPort 80 -FrontendIpConfiguration $slb.FrontendIpConfigurations[0] -FrontendPort 80 -Name $LBRuleName -Probe $probe -Protocol Tcp
```

The New-AzLoadBalancerRuleConfig cmdlet creates a rule configuration for an Azure load balancer. (autogenerated)
