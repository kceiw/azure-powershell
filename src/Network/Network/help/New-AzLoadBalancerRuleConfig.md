...
PS C:> New-AzLoadBalancerRuleConfig -BackendAddressPool $backendAddressPool -BackendPort 80 -EnableFloatingIP  -FrontendIpConfiguration $slb.FrontendIpConfigurations[0] -FrontendPort 80 -IdleTimeoutInMinutes 15 -LoadDistribution SourceIP -Name $LBRuleName -Protocol Tcp
```
