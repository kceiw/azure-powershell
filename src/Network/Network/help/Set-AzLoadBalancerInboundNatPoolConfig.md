...
Sets an inbound NAT pool configuration for a load balancer. (autogenerated)

<!-- Aladdin Generated Example -->
```powershell
Set-AzLoadBalancerInboundNatPoolConfig -BackendPort 2001 -FrontendIpConfiguration <PSFrontendIPConfiguration> -FrontendPortRangeEnd 3000 -FrontendPortRangeStart 2001 -LoadBalancer <PSLoadBalancer> -Name 'myInboundNatPool' -Protocol TCP
```
