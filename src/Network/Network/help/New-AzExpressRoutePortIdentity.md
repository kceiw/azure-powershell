...
PS C:> New-AzExpressRoutePortIdentity -UserAssignedIdentityId $Identity.Id
```

The New-AzExpressRoutePortIdentity cmdlet creates a local Azure ExpressRoutePort Identity object (autogenerated)
