...
PS C:> Remove-AzVpnClientRootCertificate -PublicCertData $CertificateText -ResourceGroupName ContosoResourceGroup -VirtualNetworkGatewayName ContosoVirtualGateway-VpnClientRootCertificateName -VpnClientRootCertificateName ContosoClientRootCertificate
```

The Remove-AzVpnClientRootCertificate cmdlet removes the specified root certificate from a virtual network gateway (autogenerated)
