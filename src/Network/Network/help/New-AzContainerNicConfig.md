...
PS C:> New-AzContainerNicConfig -IpConfiguration containerNicConfigIpConfig -Name cnic
```

The New-AzContainerNicConfig cmdlet creates a new container network interface configuration object (autogenerated)
