...
PS C:> Remove-AzLoadBalancerProbeConfig -Name MyProbe
```

The Remove-AzLoadBalancerProbeConfig cmdlet removes a probe configuration from a load balancer. (autogenerated)
