...
PS C:> Add-AzLoadBalancerRuleConfig -BackendAddressPool $Pool -BackendPort 3350 -FrontendIpConfiguration $slb.FrontendIpConfigurations[0] -FrontendPort 3350 -LoadBalancer $loadbalancer -Name NewRule -Probe $probe -Protocol Tcp
```

The Add-AzLoadBalancerRuleConfig cmdlet adds a rule configuration to an Azure load balancer. (autogenerated)
