...
```powershell
Set-AzLoadBalancerInboundNatRuleConfig -BackendPort 3350 -FrontendIpConfiguration <PSFrontendIPConfiguration> -FrontendPort 3350 -IdleTimeoutInMinutes 5 -Name 'NewNatRule' -Protocol 'Tcp' -LoadBalancer <PSLoadBalancer>
```
