...
### Example 1: 1: Get an IP configuration of a network interface
```powershell
...
The Get-AzNetworkInterfaceIPConfig cmdlet gets a network interface IP configuration from an Azure network interface. (autogenerated)
