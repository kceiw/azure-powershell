...
### Example 1: 1: Creates a private endpoint and replace one of its subnets to another
```powershell
...
PS C:> Set-AzPrivateEndpoint -PrivateEndpoint <PSPrivateEndpoint>
```

The Set-AzPrivateEndpoint cmdlet updates a private endpoint. (autogenerated)
