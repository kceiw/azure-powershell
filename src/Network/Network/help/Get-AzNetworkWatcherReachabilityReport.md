...
PS C:> Get-AzNetworkWatcherReachabilityReport -Country United States -EndTime 2017-10-12 -Location West US -NetworkWatcherName nw1 -ResourceGroupName MyResourceGroup -StartTime 2017-10-10 -State washington
```

The Get-AzNetworkWatcherReachabilityReport gets the relative latency score for internet service providers from a specified location to Azure regions. (autogenerated)
