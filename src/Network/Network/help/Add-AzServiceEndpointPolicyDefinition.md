...
## DESCRIPTION
The **Add-AzServiceEndpointPolicyDefinition** cmdlet add a service endpoint policy definition to the policy.
...
PS C:> Add-AzServiceEndpointPolicyDefinition -Name cert01 -Service Microsoft.Storage -ServiceEndpointPolicy $Policy -ServiceResource {ServiceResource}
```

The Add-AzServiceEndpointPolicyDefinition cmdlet add a service endpoint policy definition to the policy. (autogenerated)
