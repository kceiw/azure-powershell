...
Modifies an IP configuration for an application gateway. (autogenerated)

<!-- Aladdin Generated Example -->
```powershell
Set-AzApplicationGatewayIPConfiguration -ApplicationGateway <PSApplicationGateway> -Name 'AppgwSubnet01' -SubnetId '/subscriptions/xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx/resourceGroups/ResourceGroup1/providers/Microsoft.Network/virtualNetworks/VirtualNetwork1/subnets/Subnet1'
```
