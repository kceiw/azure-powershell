...
Modifies the WAF configuration of an application gateway. (autogenerated)

<!-- Aladdin Generated Example -->
```powershell
Set-AzApplicationGatewayWebApplicationFirewallConfiguration -ApplicationGateway <PSApplicationGateway> -DisabledRuleGroup <PSApplicationGatewayFirewallDisabledRuleGroup[]> -Enabled $true -Exclusion <PSApplicationGatewayFirewallExclusion[]> -FirewallMode Detection -RequestBodyCheck $false -RuleSetType OWASP -RuleSetVersion 3.0
```
