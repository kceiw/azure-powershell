...
```powershell
Set-AzApplicationGatewayWebApplicationFirewallConfiguration -ApplicationGateway <PSApplicationGateway> -DisabledRuleGroup <PSApplicationGatewayFirewallDisabledRuleGroup[]> -Enabled $true -FirewallMode Detection -RuleSetType OWASP -RuleSetVersion 3.0
```
