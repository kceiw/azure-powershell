...
## DESCRIPTION
The **Remove-AzVpnClientRevokedCertificate** cmdlet removes a client-revocation certificate from a virtual network gateway.
...
PS C:> Remove-AzVpnClientRevokedCertificate -ResourceGroupName MyResourceGroup -Thumbprint E3A38EBA60CAA1C162785A2E1C44A15AD450199C3 -VirtualNetworkGatewayName ContosoVirtualNetwork -VpnClientRevokedCertificateName ContosoRevokedClientCertificate-Thumbprint
```

The Remove-AzVpnClientRevokedCertificate cmdlet removes a client-revocation certificate from a virtual network gateway (autogenerated)
