...
Updates an existing HubVirtualNetworkConnection. (autogenerated)

<!-- Aladdin Generated Example -->
```powershell
Update-AzVirtualHubVnetConnection -Name 'testvnetconnection' -ParentResourceName 'westushub' -ResourceGroupName 'testRG' -RoutingConfiguration <PSRoutingConfiguration>
```
