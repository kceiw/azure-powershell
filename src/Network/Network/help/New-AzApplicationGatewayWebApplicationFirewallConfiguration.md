...
PS C:> New-AzApplicationGatewayWebApplicationFirewallConfiguration -Enabled $true -FirewallMode Detection
```

The New-AzApplicationGatewayWebApplicationFirewallConfiguration cmdlet creates a web application firewall (WAF) configuration for an Azure application gateway. (autogenerated)
