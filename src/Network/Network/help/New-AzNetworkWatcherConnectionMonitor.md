...
Creates a connection monitor resource. (autogenerated)

<!-- Aladdin Generated Example -->
```powershell
New-AzNetworkWatcherConnectionMonitor -Name cm -NetworkWatcherName nw1 -ResourceGroupName myresourcegroup -TestGroup <PSNetworkWatcherConnectionMonitorTestGroupObject[]>
```
