...
PS C:> Remove-AzApplicationGatewayFirewallPolicy -Force  -Name ApplicationGatewayFirewallPolicy01 -ResourceGroupName ResourceGroup01 -WhatIf 
```

The Remove-AzApplicationGatewayFirewallPolicy cmdlet removes an application gateway firewall policy. (autogenerated)
