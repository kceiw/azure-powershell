...
PS C:> New-AzVpnSite -AddressSpace $vpnSiteAddressSpaces -DeviceVendor SomeDeviceVendor -IpAddress 1.2.3.4 -LinkSpeedInMbps 10 -Location East US -Name testVpnSite -ResourceGroupName multilink -VirtualWanName <String> -VirtualWanResourceGroupName <String>
```
