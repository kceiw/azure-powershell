...
### Example 1: 1: Create a new public Ip prefix
```powershell
...
PS C:> New-AzPublicIpPrefix -Location eastus2 -Name $prefixName -PrefixLength 30 -ResourceGroupName $rgName
```

The New-AzPublicIpPrefix cmdlet creates a public IP prefix. (autogenerated)
