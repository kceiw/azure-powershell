...
PS C:> Set-AzLoadBalancerOutboundRuleConfig -BackendAddressPool $slb.BackendAddressPools[0] -FrontendIpConfiguration $slb.FrontendIpConfigurations[0] -IdleTimeoutInMinutes 10 -Name NewRule -Protocol Tcp
```
