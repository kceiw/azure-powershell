...
Delete a virtual hub route table resource associated with a virtual hub. (autogenerated)

<!-- Aladdin Generated Example -->
```powershell
Remove-AzVirtualHubRouteTable -HubName <String> -Name 'cert01' -ResourceGroupName myresourcegroup
```
