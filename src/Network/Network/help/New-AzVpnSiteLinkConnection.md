...
Creates an Azure VpnSiteLinkConnection object. (autogenerated)

<!-- Aladdin Generated Example -->
```powershell
New-AzVpnSiteLinkConnection -ConnectionBandwidth 10 -EnableBgp -Name 'testLinkConnection1' -SharedKey <SecureString> -VpnSiteLink <PSVpnSiteLink>
```
