...
PS C:> Set-AzApplicationGatewayProbeConfig -ApplicationGateway Gateway -HostName contoso.com -Interval 30 -Match {Match} -Name Probe05 -Path /path/custompath.htm -Protocol Http -Timeout 120 -UnhealthyThreshold 8
```

The Set-AzApplicationGatewayProbeConfig cmdlet sets the health probe configuration on an existing Application Gateway. (autogenerated)
