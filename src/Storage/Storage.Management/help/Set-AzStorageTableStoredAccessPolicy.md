...
Sets the stored access policy for an Azure storage table. (autogenerated)

<!-- Aladdin Generated Example -->
```powershell
Set-AzStorageTableStoredAccessPolicy -ExpiryTime <DateTime> -Policy 'Policy08' -Table 'MyTable'
```
