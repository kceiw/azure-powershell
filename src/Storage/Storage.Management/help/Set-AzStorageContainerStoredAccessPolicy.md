...
Sets a stored access policy for an Azure storage container. (autogenerated)

<!-- Aladdin Generated Example -->
```powershell
Set-AzStorageContainerStoredAccessPolicy -Container 'MyContainer' -Context <IStorageContext> -ExpiryTime <DateTime> -Permission rwdl -Policy 'Policy06'
```
