...
Gets the state of a copy operation. (autogenerated)

<!-- Aladdin Generated Example -->
```powershell
Get-AzStorageFileCopyState -Context <IStorageContext> -FilePath 'ContosoFile' -ShareName 'ContosoShare' -WaitForComplete
```
