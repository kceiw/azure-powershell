...
Creates an account-level SAS token. (autogenerated)

<!-- Aladdin Generated Example -->
```powershell
New-AzStorageAccountSASToken -Context <IStorageContext> -ExpiryTime <DateTime> -Permission 'racwdlup' -Protocol HttpsOnly -ResourceType None -Service None -StartTime <DateTime>
```
