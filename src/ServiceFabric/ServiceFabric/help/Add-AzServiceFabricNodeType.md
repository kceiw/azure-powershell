...
Add a new node type to the existing cluster. (autogenerated)

<!-- Aladdin Generated Example -->
```powershell
Add-AzServiceFabricNodeType -Capacity 5 -Name 'Contoso01SFCluster' -NodeType 'n2' -ResourceGroupName 'Group1' -VmPassword <SecureString> -VmSku <String> -VmUserName 'adminName'
```
