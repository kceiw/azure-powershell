...
## DESCRIPTION
Use this cmdlet to get the application type details in the specified resource group and cluster.
...
This example will get a list of the application types defined under the specified cluster.
