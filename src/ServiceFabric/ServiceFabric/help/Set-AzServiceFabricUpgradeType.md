...
## DESCRIPTION
Use **Set-AzServiceFabricUpgradeType** to set upgrade type to automatic or manual with specific Service Fabric code version.
...
Use Set-AzServiceFabricUpgradeType to set upgrade type to automatic or manual with specific Service Fabric code version. (autogenerated)
