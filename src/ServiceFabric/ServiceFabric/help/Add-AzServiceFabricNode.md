...
Add nodes to the specific node type in the cluster. (autogenerated)

<!-- Aladdin Generated Example -->
```powershell
Add-AzServiceFabricNode -Name 'Contoso01SFCluster' -NodeType <String> -NumberOfNodesToAdd 2 -ResourceGroupName 'Group1'
```
