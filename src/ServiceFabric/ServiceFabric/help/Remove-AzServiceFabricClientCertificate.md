...
PS C:> Remove-AzServiceFabricClientCertificate -CommonName Contoso.com -IssuerThumbprint 5F3660C715EBBDA31DB1FFDCF508302348DE8E7A -Name Contoso01SFCluster -ResourceGroupName Group1
```

Use Remove-AzServiceFabricClientCertificate to remove a client certificate(s) or certificate subject(s) name(s) from being used for client authentication to the cluster. (autogenerated)
