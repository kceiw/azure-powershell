...
PS C:> Remove-AzServiceFabricNode -Name Contoso01SFCluster -NodeType n2 -NumberOfNodesToRemove 2 -ResourceGroupName Group1 -WhatIf 
```

Use Remove-AzServiceFabricNode to remove nodes from a specific node type from a cluster (autogenerated)
