...
PS C:> Remove-AzCdnEndpoint -EndpointName $endpointName -Force  -ProfileName $profileName -ResourceGroupName MyResourceGroup
```

The Remove-AzCdnEndpoint cmdlet removes an Azure Content Delivery Network (CDN) endpoint. (autogenerated)
