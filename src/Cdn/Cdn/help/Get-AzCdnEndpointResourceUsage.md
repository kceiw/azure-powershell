...
PS C:> Get-AzCdnEndpointResourceUsage -EndpointName $endpointName -ProfileName $profileName -ResourceGroupName MyResourceGroup
```

{{Fill in the Description}}. (autogenerated)
