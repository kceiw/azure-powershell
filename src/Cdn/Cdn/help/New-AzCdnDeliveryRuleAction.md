...
### CacheExpirationActionParameterSet (Default)
```
...
PS C:> New-AzCdnDeliveryRuleAction -DestinationProtocol {DestinationProtocol} -RedirectType <String>
```

The New-AzCdnDeliveryRule cmdlet creates a delivery rule for CDN endpoint creation. (autogenerated)
