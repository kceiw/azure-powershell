...
PS C:> New-AzCdnCustomDomain -CustomDomainName $customDomainName -EndpointName $endpointName -HostName <String> -ProfileName $profileName -ResourceGroupName MyResourceGroup
```

The New-AzCdnCustomDomain cmdlet creates a custom domain for the Azure Content Delivery Network (CDN) endpoint. (autogenerated)
