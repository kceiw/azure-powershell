...
PS C:> Remove-AzCdnProfile -ProfileName $profileName -ResourceGroupName MyResourceGroup
```

The Remove-AzCdnProfile cmdlet removes a Azure Content Delivery Network (CDN) profile. (autogenerated)
