...
PS C:> Start-AzCdnEndpoint -EndpointName $endpointName -ProfileName $profileName -ResourceGroupName MyResourceGroup
```

The Start-AzCdnEndpoint cmdlet starts an Azure Content Delivery Network (CDN) endpoint. (autogenerated)
