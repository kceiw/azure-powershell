...
PS C:> Get-AzCdnProfileSsoUrl -ProfileName $profileName -ResourceGroupName MyResourceGroup
```

The Get-AzCdnProfileSsoUrl cmdlet gets the single sign-on URL of the Azure Content Delivery Network (CDN) profile (autogenerated)
