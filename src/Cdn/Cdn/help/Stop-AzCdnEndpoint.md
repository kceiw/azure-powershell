...
PS C:> Stop-AzCdnEndpoint -EndpointName $endpointName -ProfileName $profileName -ResourceGroupName MyResourceGroup
```

The Stop-AzCdnEndpoint cmdlet stops the Azure Content Delivery Network (CDN) endpoint. (autogenerated)
