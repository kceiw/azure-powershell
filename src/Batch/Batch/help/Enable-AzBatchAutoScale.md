...
PS C:> Enable-AzBatchAutoScale -AutoScaleEvaluationInterval {AutoScaleEvaluationInterval} -AutoScaleFormula $Formula -BatchContext $Context -Id MyPool
```

The Enable-AzBatchAutoScale cmdlet enables automatic scaling of the specified pool. (autogenerated)
