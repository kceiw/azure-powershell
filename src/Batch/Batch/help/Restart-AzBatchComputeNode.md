...
PS C:> Restart-AzBatchComputeNode -BatchContext $Context -RebootOption Requeue
```

The Restart-AzBatchComputeNode cmdlet reboots the specified compute node. (autogenerated)
