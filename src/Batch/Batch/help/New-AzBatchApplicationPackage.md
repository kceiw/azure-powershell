...
PS C:> New-AzBatchApplicationPackage -AccountName ContosoBatch -ApplicationName Litware -ApplicationVersion 1.0 -FilePath litware.1.0.zip -Format zip -ResourceGroupName ContosoBatchGroup
```
