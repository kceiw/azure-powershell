...
PS C:> Get-AzBatchJobSchedule -BatchContext $Context
```

The Get-AzBatchJobSchedule cmdlet gets Azure Batch job schedules for the Batch account specified by the BatchContext parameter (autogenerated)
