...
PS C:> New-AzBatchAccountKey -AccountName pfuller -KeyType Primary -ResourceGroupName MyResourceGroup
```

The New-AzBatchAccountKey cmdlet regenerates the primary or secondary key of an Azure Batch account (autogenerated)
