...
PS C:> Set-AzDataLakeAnalyticsAccount -FirewallState Enabled -Name ContosoAdlAcct
```

The Set-AzDataLakeAnalyticsAccount cmdlet modifies an Azure Data Lake Analytics account. (autogenerated)
