...
PS C:> Sync-AzMediaServiceStorageKey -AccountName MediaService1 -ResourceGroupName ResourceGroup001 -StorageAccountId $StorageAccount.Id
```

The Sync-AzMediaServiceStorageKey cmdlet synchronizes storage account keys for a storage account associated with the media service. (autogenerated)
