...
Synchronizes storage account keys for a storage account associated with the media service. (autogenerated)

<!-- Aladdin Generated Example -->
```powershell
Sync-AzMediaServiceStorageKey -AccountName 'MediaService1' -ResourceGroupName 'ResourceGroup001' -StorageAccountId <String>
```
