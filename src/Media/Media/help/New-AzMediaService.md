...
### Example 1: 1: Create a media service with the primary storage account only
```powershell
PS C:\># Variables
## Global
...
PS C:> New-AzMediaService -AccountName MediaService1 -Location westus -ResourceGroupName MyResourceGroup -StorageAccountId $StorageAccount.Id
```

The New-AzMediaService cmdlet creates a media service (autogenerated)
