...
Creates a new Azure Event Grid Topic. (autogenerated)

<!-- Aladdin Generated Example -->
```powershell
New-AzEventGridTopic -InputSchema EventGridSchema -Location westus2 -Name Topic1 -ResourceGroupName MyResourceGroupName
```
