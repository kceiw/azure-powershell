...
PS C:> Remove-AzDataMigrationService -Confirm  -Force  -Name TestService -ResourceGroupName MyResourceGroup
```

The Remove-AzDataMigrationService cmdlet removes an instance of the Azure Database Migration Service from Azure (autogenerated)
