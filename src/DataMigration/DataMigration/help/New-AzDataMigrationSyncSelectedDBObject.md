...
PS C:> New-AzDataMigrationSyncSelectedDBObject -MigrationSetting {MigrationSetting} -SchemaName <String> -SourceDatabaseName AdventureWorks2016 -SourceSetting {SourceSetting} -TableMap <Hashtable> -TargetDatabaseName <String>
```
