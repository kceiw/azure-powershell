...
PS C:> Remove-AzDataMigrationProject -Force  -Name myDMProject -ResourceGroupName myResourceGroup -ServiceName myDMService
```

The Remove-AzDataMigrationProject cmdlet removes an Azure Database Migration Service project from Azure (autogenerated)
