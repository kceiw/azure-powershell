...
PS C:> Get-AzDataShareSubscription -AccountName WikiAds -ResourceGroupName ADS
```

The Get-AzDataShareSubscription cmdlet provides information about share subscription in a data share account (autogenerated)
