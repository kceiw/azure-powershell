...
PS C:> New-AzDataShareDataSetMapping -AccountName WikiAdsAccount -Container AdsContainer -DataSetId <String> -Name AdsDataSetMapping -ResourceGroupName ADS -ShareSubscriptionName AdsShareSubscription -StorageAccountResourceId /subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/ADS/providers/Microsoft.Storage/storageAccounts/AdsStorage
```

The New-AzDataShareDataSetMapping cmdlet creates a data set mapping between the source data sets and sink storage account in share subscription. (autogenerated)
