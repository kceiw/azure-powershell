...
PS C:> New-AzDataShareDataSet -AccountName WikiAds -Container AdsContainer -Name AdsDataSet -ResourceGroupName MyResourceGroup -ShareName AdsShare -StorageAccountResourceId /subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/ADS/providers/Microsoft.Storage/storageAccounts/AdsStorage
```

The New-AzDataShareDataSet cmdlet add data sets in azure data share of data share account (autogenerated)
