...
PS C:> Get-AzDataShareSynchronizationSetting -AccountName WikiAds -ResourceGroupName ADS -ShareName AdsShare
```

The Get-AzDataShareSynchronizationSetting cmdlet provides information about synchronization enabled on a share. (autogenerated)
