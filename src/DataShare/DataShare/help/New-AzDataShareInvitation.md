...
Creates an invitation for share. (autogenerated)

<!-- Aladdin Generated Example -->
```powershell
New-AzDataShareInvitation -AccountName 'WikiAds' -Name 'AdsInvitation' -ResourceGroupName 'ADS' -ShareName 'AdsShare' -TargetObjectId <String> -TargetTenantId <String>
```
