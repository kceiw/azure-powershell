...
PS C:> Remove-AzSqlElasticJob -AgentName agent -Force  -Name job1 -ResourceGroupName MyResourceGroup -ServerName s1
```

The Remove-AzSqlElasticJob cmdlet removes a job. (autogenerated)
