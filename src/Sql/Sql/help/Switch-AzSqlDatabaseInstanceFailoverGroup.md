...
PS C:> Switch-AzSqlDatabaseInstanceFailoverGroup -AllowDataLoss 
```

This command swaps the roles of the managed instances in a Instance Failover Group by failing over to the specified secondary region, making it the new primary region (autogenerated)
