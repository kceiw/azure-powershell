...
PS C:> Set-AzSqlServer -AssignIdentity  -ResourceGroupName ResourceGroup01 -ServerName Server01
```

The Set-AzSqlServer cmdlet modifies properties of an Azure SQL Database server. (autogenerated)
