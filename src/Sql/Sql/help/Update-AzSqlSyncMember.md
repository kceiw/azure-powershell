...
```powershell
Update-AzSqlSyncMember -DatabaseName 'Database01' -Name 'SyncMember01' -ResourceGroupName 'ResourceGroup01' -ServerName 'Server01' -SyncGroupName 'SyncGroup01' -SyncMemberAzureDatabaseResourceId <String> -UsePrivateLinkConnection
```
