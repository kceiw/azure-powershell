...
PS C:> Start-AzSqlSyncGroupSync -DatabaseName db1 -ResourceGroupName MyResourceGroup -ServerName s1 -SyncGroupName mysg
```

The Start-AzSqlSyncGroupSync cmdlet starts a sync group synchronization. (autogenerated)
