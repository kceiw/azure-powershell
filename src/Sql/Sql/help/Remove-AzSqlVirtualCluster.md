...
PS C:> Remove-AzSqlVirtualCluster -Name VirtualCluster1 -ResourceGroupName ResourceGroup01 -WhatIf 
```

The Remove-AzSqlVirtualCluster cmdlet removes an Azure SQL Virtual Cluster. (autogenerated)
