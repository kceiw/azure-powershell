...
PS C:> New-AzSqlDatabaseExport -AdministratorLogin User -AdministratorLoginPassword secure password -AuthenticationType None -DatabaseName Database01 -ResourceGroupName RG01 -ServerName Server01 -StorageKey StorageKey01 -StorageKeyType StorageAccessKey -StorageUri http://account01.blob.core.contoso.net/bacpacs/database01.bacpac
```

The New-AzSqlDatabaseExport cmdlet exports an Azure SQL Database as a .bacpac file to a storage account (autogenerated)
