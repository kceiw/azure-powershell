...
New-AzSqlDatabaseExport -AdministratorLogin 'User' -AdministratorLoginPassword 'secure password' -DatabaseName 'Database01' -ResourceGroupName 'RG01' -ServerName 'Server01' -StorageKey 'StorageKey01' -StorageKeyType StorageAccessKey -StorageUri 'https://account01.blob.core.contoso.net/bacpacs/database01.bacpac'
```
