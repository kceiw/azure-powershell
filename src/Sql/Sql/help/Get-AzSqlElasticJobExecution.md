...
PS C:> Get-AzSqlElasticJobExecution -AgentName agent -Count 3 -JobName job1 -ResourceGroupName rg -ServerName elasticjobserver
```

The Get-AzSqlElasticJobExecution cmdlet gets one or more job executions. (autogenerated)
