...
PS C:> Stop-AzSqlSyncGroupSync -DatabaseName db1 -ResourceGroupName MyResourceGroup -ServerName s1 -SyncGroupName mysg
```

The Stop-AzSqlSyncGroupSync cmdlet stops a sync group synchronization. (autogenerated)
