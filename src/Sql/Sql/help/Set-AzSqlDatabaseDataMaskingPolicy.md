...
PS C:> Set-AzSqlDatabaseDataMaskingPolicy -DatabaseName db1 -PrivilegedUsers {PrivilegedUsers} -ResourceGroupName MyResourceGroup -ServerName s1
```

The Set-AzSqlDatabaseDataMaskingPolicy cmdlet sets the data masking policy for an Azure SQL database (autogenerated)
