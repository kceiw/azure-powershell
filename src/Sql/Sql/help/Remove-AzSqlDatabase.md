...
PS C:> Remove-AzSqlDatabase -DatabaseName Database01 -Force  -ResourceGroupName ResourceGroup01 -ServerName Server01
```

The Remove-AzSqlDatabase cmdlet removes an Azure SQL database (autogenerated)
