...
Modifies the configuration of an Azure SQL Database Failover Group. (autogenerated)

<!-- Aladdin Generated Example -->
```powershell
Set-AzSqlDatabaseFailoverGroup -AllowReadOnlyFailoverToPrimary Enabled -FailoverGroupName fg -ResourceGroupName rg -ServerName primaryserver
```
