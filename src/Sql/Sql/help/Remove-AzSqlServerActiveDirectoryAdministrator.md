...
PS C:> Remove-AzSqlServerActiveDirectoryAdministrator -Force  -ResourceGroupName ResourceGroup01 -ServerName Server01
```

The Remove-AzSqlServerActiveDirectoryAdministrator cmdlet removes an Azure Active Directory (Azure AD) administrator for AzureSQL Server in the current subscription. (autogenerated)
