...
PS C:> Get-AzSqlDatabaseDataMaskingRule -DatabaseName Database01 -ResourceGroupName ResourceGroup01 -ServerName Server01 -TableName table1
```

The Get-AzSqlDatabaseDataMaskingRule cmdlet gets either a specific data masking rule or all of the data masking rules for an Azure SQL database (autogenerated)
