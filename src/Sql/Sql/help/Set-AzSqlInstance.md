...
PS C:> Set-AzSqlInstance -Force  -PublicDataEndpointEnabled 
```

The Set-AzSqlInstance cmdlet modifies properties of an Azure SQL Database Managed instance. (autogenerated)
