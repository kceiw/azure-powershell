...
PS C:> Get-AzSqlDatabaseReplicationLink -DatabaseName db1 -PartnerResourceGroupName rg2 -ResourceGroupName MyResourceGroup -ServerName s1
```

The Get-AzSqlDatabaseReplicationLink cmdlet replaces the Get-AzSqlDatabaseCopy cmdlet (autogenerated)
