...
### Example 3: 3.1: Enable the blob storage auditing policy of an Azure SQL database with advanced filtering using a T-SQL predicate
```powershell
...
### Example 4: 3.2: Remove the advanced filtering setting from the auditing policy of an Azure SQL database
```powershell
