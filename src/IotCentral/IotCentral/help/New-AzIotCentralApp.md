...
PS C:> New-AzIotCentralApp -DisplayName My Custom Display Name -Name MyAppResourceName -ResourceGroupName MyResourceGroupName -Sku S1 -Subdomain MyAppSubdomain -Template iotc-default
```

Creates a new IoT Central Application with the provided properties and metadata (autogenerated)
