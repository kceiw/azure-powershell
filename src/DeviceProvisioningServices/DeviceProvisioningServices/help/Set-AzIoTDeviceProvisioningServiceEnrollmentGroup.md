...
Update a device enrollment group. (autogenerated)

<!-- Aladdin Generated Example -->
```powershell
Set-AzIoTDeviceProvisioningServiceEnrollmentGroup -AllocationPolicy Hashed -ApiVersion <String> -DpsName 'mydps' -Name 'enroll1' -ReprovisionPolicy reprovisionandmigratedata -ResourceGroupName 'myresourcegroup' -WebhookUrl <String>
```
