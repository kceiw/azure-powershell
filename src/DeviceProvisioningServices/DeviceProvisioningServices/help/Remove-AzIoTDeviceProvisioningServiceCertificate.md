...
PS C:> Remove-AzIoTDeviceProvisioningServiceCertificate -CertificateName mycertificate -Etag AAAAAAFPazE= -Name myiotdps -ResourceGroupName myresourcegroup
```

For a detailed explanation of CA certificates in Azure IoT Hub Device Provisioning Service, see https://docs.microsoft.com/en-us/azure/iot-dps/how-to-verify-certificates. (autogenerated)
