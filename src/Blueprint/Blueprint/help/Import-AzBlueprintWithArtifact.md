...
Import a blueprint file in JSON format to a blueprint object and save it within the specified subscription or management group. (autogenerated)

<!-- Aladdin Generated Example -->
```powershell
Import-AzBlueprintWithArtifact -InputPath C:\Blueprints\SimpleBlueprint -ManagementGroupId 'myManagementGroup' -Name MySimpleBlueprint
```
