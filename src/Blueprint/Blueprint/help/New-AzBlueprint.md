...
Create a new blueprint definition and save it within the specified subscription or management group. (autogenerated)

<!-- Aladdin Generated Example -->
```powershell
New-AzBlueprint -BlueprintFile C:\Blueprint.json -ManagementGroupId 'myManagementGroup' -Name MyNewBlueprint
```
