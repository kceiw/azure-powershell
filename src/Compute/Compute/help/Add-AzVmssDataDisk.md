...
PS C:> Add-AzVmssDataDisk -Caching None -CreateOption Empty -DiskSizeGB 10 -Lun 0 -StorageAccountType StandardLRS -VirtualMachineScaleSet $vmss
```

The Add-AzVmssDataDisk cmdlet adds a data disk to the Virtual Machine Scale Set (VMSS) instance. (autogenerated)
