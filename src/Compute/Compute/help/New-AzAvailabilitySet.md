...
```powershell
New-AzAvailabilitySet -Location 'West US' -Name 'AvailabilitySet03' -PlatformFaultDomainCount <Int32> -PlatformUpdateDomainCount <Int32> -ResourceGroupName 'ResourceGroup11' -Sku <String> -Tag 'Sql'
```
