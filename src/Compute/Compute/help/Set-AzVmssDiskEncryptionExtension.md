...
PS C:> Set-AzVmssDiskEncryptionExtension -DiskEncryptionKeyVaultId $KeyVaultResourceId -DiskEncryptionKeyVaultUrl $DiskEncryptionKeyVaultUrl -Force  -ResourceGroupName $RGName -VMScaleSetName $VmssName -VolumeType $volumeType
```

The Set-AzVmssDiskEncryptionExtension cmdlet enables encryption on a VM scale set (autogenerated)
