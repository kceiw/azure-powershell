...
PS C:> Add-AzVmssWinRMListener -Protocol Http -VirtualMachineScaleSet $VMSS
```

The Add-AzVmssWinRMListener cmdlet adds a Windows Remote Management (WinRM) listener on the Virtual Machine Scale Set (VMSS). (autogenerated)
