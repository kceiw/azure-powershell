...
PS C:> Add-AzVmssExtension -Name $ExtName -Publisher $Publisher -Setting {Setting} -Type $ExtType -TypeHandlerVersion $ExtVer -VirtualMachineScaleSet $VMSS
```

The Add-AzVmssExtension cmdlet adds an extension to the Virtual Machine Scale Set (VMSS). (autogenerated)
