...
PS C:> Disable-AzVMDiskEncryption -Force  -ResourceGroupName Group001 -VMName VM002 -VolumeType OS
```

The Disable-AzVMDiskEncryption cmdlet disables encryption on an infrastructure as a service (IaaS) virtual machine (autogenerated)
