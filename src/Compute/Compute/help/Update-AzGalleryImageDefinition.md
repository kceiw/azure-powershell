...
PS C:> Update-AzGalleryImageDefinition -Description $description -GalleryName $galleryName -Name $galleryImageDefinitionName -ResourceGroupName $resourceGroupName
```

Update a gallery image definition. (autogenerated)
