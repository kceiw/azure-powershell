...
PS C:> Update-AzGalleryImageVersion -AsJob  -GalleryImageDefinitionName {GalleryImageDefinitionName} -GalleryName $galleryName -Name $versionName -ResourceGroupName $rgname -Tag Sql -TargetRegion $targetRegions
```

Update a gallery image version. (autogenerated)
