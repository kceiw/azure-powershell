...
PS C:> Set-AzVmssRollingUpgradePolicy -MaxBatchInstancePercent 40 -MaxUnhealthyInstancePercent 35 -MaxUnhealthyUpgradedInstancePercent 30 -PauseTimeBetweenBatches PT30S -VirtualMachineScaleSet $vmss
```
