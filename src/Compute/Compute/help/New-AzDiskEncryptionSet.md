...
Creates disk encryption set using the given active key in the key vault. (autogenerated)

<!-- Aladdin Generated Example -->
```powershell
New-AzDiskEncryptionSet -InputObject <PSDiskEncryptionSet> -Name 'enc1' -ResourceGroupName 'rg1'
```
