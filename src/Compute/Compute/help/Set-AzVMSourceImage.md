...
PS C:> Set-AzVMSourceImage -Id /subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/contoso/providers/Microsoft.Network/networkInterfaces/sshNIC -VM $VirtualMachine
```

The Set-AzVMSourceImage cmdlet specifies the platform image to use for a virtual machine. (autogenerated)
