...
PS C:> New-AzDiskConfig -CreateOption Empty -Location Central US -SkuName PremiumLRS -SourceResourceId {SourceResourceId}
```

The New-AzDiskConfig cmdlet creates a configurable disk object. (autogenerated)
