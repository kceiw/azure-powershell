...
PS C:> Set-AzVMOperatingSystem -ComputerName $ComputerName -Credential $Credential -CustomData $CustomData -EnableAutoUpdate  -ProvisionVMAgent  -VM $$VirtualMachine -WinRMCertificateUrl $WinRMCertUrl -WinRMHttp  -WinRMHttps  -Windows 
```

The Set-AzVMOperatingSystem cmdlet sets operating system properties for a virtual machine (autogenerated)
