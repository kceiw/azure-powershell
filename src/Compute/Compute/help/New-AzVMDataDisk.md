...
```powershell
New-AzVMDataDisk -Caching None -CreateOption Attach -DiskSizeInGB 1 -Lun 2 -Name 'AgentPool01' -VhdUri 'https://contoso.blob.core.windows.net/vhds/diskstandard03.vhd'
```
