...
PS C:> Remove-AzVmss -Force  -InstanceId 3 -ResourceGroupName Group001 -VMScaleSetName VMScaleSet001
```

The Remove-AzVmss cmdlet removes the Virtual Machine Scale Set (VMSS) from Azure (autogenerated)
