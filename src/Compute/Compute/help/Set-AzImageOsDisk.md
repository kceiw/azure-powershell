...
PS C:> Set-AzImageOsDisk -Image $imageConfig -ManagedDiskId $disk.Id -OsState Generalized -OsType Windows
```

The Set-AzImageOsDisk cmdlet sets the operating system disk properties on an image object. (autogenerated)
