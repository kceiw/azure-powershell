...
PS C:> Set-AzVMADDomainExtension -Credential $vmCred -DomainName <String> -JoinOption {JoinOption} -Location westus -OUPath {OUPath} -ResourceGroupName MyResourceGroup -Restart  -VMName VM01
```

The Set-AzVMADDomainExtension cmdlet adds an Azure Active Directory (AD) domain virtual machine extension to a virtual machine (autogenerated)
