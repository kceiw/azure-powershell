...
PS C:> Set-AzVMADDomainExtension -Credential $vmCred -DefaultProfile $context -DomainName <String> -JoinOption {JoinOption} -ResourceGroupName MyResourceGroup -VMName VM01
```
