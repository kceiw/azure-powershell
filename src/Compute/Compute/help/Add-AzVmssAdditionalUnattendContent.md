...
PS C:> Add-AzVmssAdditionalUnattendContent -ComponentName MicrosoftWindowsShellSetup -Content $AUCContent -PassName OobeSystem -SettingName AutoLogon
```

The Add-AzVmssAdditionalUnattendContent cmdlet adds information to the unattended Windows Setup answer file. (autogenerated)
