...
PS C:> Get-AzVMDscExtensionStatus -Name AgentPool01 -ResourceGroupName MyResourceGroup -VMName VM01
```

The Get-AzVMDscExtensionStatus cmdlet gets the status of the Desired State Configuration (DSC) extension handler for a virtual machine in a resource group (autogenerated)
