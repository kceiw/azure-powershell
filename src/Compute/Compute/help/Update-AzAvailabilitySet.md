...
## DESCRIPTION
The **Update-AzAvailabilitySet** cmdlet updates an availability set.
...
PS C:> Update-AzAvailabilitySet -AvailabilitySet {AvailabilitySet} -Sku $skuName -Tag Sql
```

The Update-AzAvailabilitySet cmdlet updates an availability set. (autogenerated)
