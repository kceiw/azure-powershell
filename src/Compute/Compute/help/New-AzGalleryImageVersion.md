...
PS C:> New-AzGalleryImageVersion -AsJob  -GalleryImageDefinitionName {GalleryImageDefinitionName} -GalleryName $galleryName -Location $location -Name $versionName -PublishingProfileExcludeFromLatest  -ResourceGroupName $rgname -SourceImageId $sourceImageId -Tag Sql -TargetRegion $targetRegions
```

Create a gallery image version. (autogenerated)
