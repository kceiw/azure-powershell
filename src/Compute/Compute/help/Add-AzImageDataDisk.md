...
PS C:> Add-AzImageDataDisk -Caching None -DiskSizeGB 10 -Image $imageConfig -Lun 1 -ManagedDiskId $disk.Id -StorageAccountType Standard_LRS
```

The Add-AzImageDataDisk cmdlet adds a data disk to an image object. (autogenerated)
