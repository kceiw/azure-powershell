...
This command gets the encryption status of the virtual machine named VM001. (autogenerated)

```powershell <!-- Aladdin Generated Example --> 
Get-AzVMDiskEncryptionStatus -ResourceGroupName myresourcegroup -VMName 'VM01'
```
