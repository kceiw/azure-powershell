...
PS C:> Set-AzVmss -ReimageAll  -ResourceGroupName ContosoGroup -VMScaleSetName ContosoVMSS
```

The Set-AzVmss cmdlet sets specific actions on the Virtual Machine Scale Set (VMSS) (autogenerated)
