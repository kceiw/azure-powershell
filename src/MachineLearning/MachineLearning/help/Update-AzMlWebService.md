...
PS C:> Update-AzMlWebService -Force  -Name mywebservicename -ResourceGroupName myresourcegroup -ServiceUpdates $updates
```

The Update-AzMlWebService cmdlet allows you to update the non-static properties of a web service (autogenerated)
