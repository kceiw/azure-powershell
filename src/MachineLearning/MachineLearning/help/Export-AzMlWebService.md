...
PS C:> Export-AzMlWebService -Force  -OutputFile C:\mlservice.json -WebService $svc
```

Exports the definition object for the specified web service as a JSON formatted string (autogenerated)
