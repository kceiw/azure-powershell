...
PS C:> Get-AzWebAppAccessRestrictionConfig -Name ContosoSite -ResourceGroupName Default-Web-WestUS -SlotName {SlotName}
```

The Get-AzWebAppAccessRestrictionConfig cmdlet gets Access Restriction config about an Azure Web App. (autogenerated)
