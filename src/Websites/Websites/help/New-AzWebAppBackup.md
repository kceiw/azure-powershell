...
PS C:> New-AzWebAppBackup -Name ContosoWebApp -ResourceGroupName Default-Web-WestUS -Slot Slot001 -StorageAccountUrl https://storageaccount.file.core.windows.net
```
