...
PS C:> New-AzWebAppDatabaseBackupSetting -ConnectionString MyConnectionString -ConnectionStringName {ConnectionStringName} -DatabaseType SqlAzure -Name ContosoWebApp
```
