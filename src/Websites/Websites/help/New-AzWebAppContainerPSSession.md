...
New-AzWebAppContainerPSSession will create new remote PowerShell Session into the windows container specified in a given site or slot and given resource group. (autogenerated)

<!-- Aladdin Generated Example -->
```powershell
New-AzWebAppContainerPSSession -Name 'ContosoASP' -ResourceGroupName 'Default-Web-WestUS' -SlotName <String>
```
