...
PS C:> Restore-AzWebAppBackup -BlobName myBlob -Name ContosoWebApp -Overwrite  -ResourceGroupName Default-Web-WestUS -StorageAccountUrl https://storageaccount.file.core.windows.net
```
