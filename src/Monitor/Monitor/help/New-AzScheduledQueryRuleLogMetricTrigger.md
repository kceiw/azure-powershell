...
## DESCRIPTION
Creates an object of type Log Metric Trigger and is optional.
This is the trigger condition for metric query rule, to be used when you need to state metric measurement type of alert.
