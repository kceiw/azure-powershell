...
```powershell
Add-AzAutoscaleSetting -AutoscaleProfile <List`1> -Location 'East US' -Name 'MySetting' -Notification <List`1> -ResourceGroupName 'Default-Web-EastUS' -TargetResourceId '/subscriptions/00000000-0000-0000-0000-00000000000000000/resourceGroups/Default-Web-EastUS/providers/microsoft.web/serverFarms/DefaultServerFarm'
```
