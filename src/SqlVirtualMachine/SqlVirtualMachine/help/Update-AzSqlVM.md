...
PS C:> Update-AzSqlVM -Name AgListener01 -ResourceGroupName MyResourceGroup -SqlManagementType {SqlManagementType}
```

The Update-AzSqlVM cmdlet updates a sql virtual machine. (autogenerated)
