...
Creates a new sql virtual machine. (autogenerated)

<!-- Aladdin Generated Example -->
```powershell
New-AzSqlVM -LicenseType 'PAYG' -Location westus -Name 'vm' -ResourceGroupName 'ResourceGroup01' -SqlManagementType <String>
```
