...
Create a PSRoutingRuleObject for Front Door creation. (autogenerated)

<!-- Aladdin Generated Example -->
```powershell
New-AzFrontDoorRoutingRuleObject -AcceptedProtocol https -BackendPoolName 'backendPool1' -ForwardingProtocol HttpsOnly -FrontDoorName <String> -FrontendEndpointName 'frontendEndpoint1' -Name <String> -ResourceGroupName <String>
```
