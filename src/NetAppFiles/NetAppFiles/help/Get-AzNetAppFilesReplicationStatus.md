...
This command gets the status of replication on MyVol (autogenerated)

<!-- Aladdin Generated Example -->
```powershell
Get-AzNetAppFilesReplicationStatus -AccountName 'MyAnfAccount' -Name 'MyAnfVolume' -PoolName 'MyAnfPool' -ResourceGroupName myresourcegroup
```
