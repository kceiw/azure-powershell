...
Creates a new Azure NetApp Files (ANF) account. (autogenerated)

<!-- Aladdin Generated Example -->
```powershell
New-AzNetAppFilesAccount -ActiveDirectory <PSNetAppFilesActiveDirectory[]> -Location 'westus2' -Name 'MyAnfAccount' -ResourceGroupName 'MyRG'
```
