...
This command gets the account named MyAnfPool from the account "MyAnfAccount". (autogenerated)

<!-- Aladdin Generated Example -->
```powershell
Get-AzNetAppFilesPool -AccountName 'MyAnfAccount' -Name 'MyAnfVolume' -ResourceGroupName myresourcegroup
```
