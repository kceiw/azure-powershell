...
PS C:> Update-AzNetAppFilesPool -AccountName MyAnfAccount -Location westus -Name MyAnfPool -PoolSize 4398046511104 -ResourceGroupName MyRG
```

The Update-AzNetAppFilesPool cmdlet modifies an ANF pool. (autogenerated)
