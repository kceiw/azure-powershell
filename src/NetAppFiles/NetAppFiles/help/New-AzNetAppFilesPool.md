...
PS C:> New-AzNetAppFilesPool -AccountName MyAnfAccount -Location westus -Name MyAnfPool -PoolSize 4398046511104 -ResourceGroupName MyRG -ServiceLevel Premium
```

The New-AzNetAppFilesPool cmdlet creates an ANF pool. (autogenerated)
