...
Updates an Azure NetApp Files (ANF) account according to the optional modifiers provided. (autogenerated)

<!-- Aladdin Generated Example -->
```powershell
Update-AzNetAppFilesAccount -ActiveDirectory <PSNetAppFilesActiveDirectory[]> -Location 'westus2' -Name 'MyAnfAccount' -ResourceGroupName 'MyRG'
```
