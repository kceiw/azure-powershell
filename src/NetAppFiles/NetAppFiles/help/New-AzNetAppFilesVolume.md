...
Creates a new Azure NetApp Files (ANF) volume. (autogenerated)

<!-- Aladdin Generated Example -->
```powershell
New-AzNetAppFilesVolume -AccountName 'MyAnfAccount' -CreationToken 'MyAnfVolume' -Location 'westus2' -Name 'MyAnfVolume' -PoolName 'MyAnfPool' -ProtocolType <String[]> -ResourceGroupName 'MyRG' -ServiceLevel 'Premium' -SubnetId '/subscriptions/subsId/resourceGroups/MyRG/providers/Microsoft.Network/virtualNetworks/MyVnetName/subnets/MySubNetName' -UsageThreshold 1099511627776
```
