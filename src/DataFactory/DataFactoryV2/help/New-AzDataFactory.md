...
PS C:> New-AzDataFactory -Force  -Location WestUS -Name WikiADF -ResourceGroupName ADF
```

The New-AzDataFactory cmdlet creates a data factory with the specified resource group name and location (autogenerated)
