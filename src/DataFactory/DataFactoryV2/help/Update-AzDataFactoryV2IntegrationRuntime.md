...
Updates an integration runtime. (autogenerated)

```powershell <!-- Aladdin Generated Example --> 
Update-AzDataFactoryV2IntegrationRuntime -AutoUpdate On -DataFactoryName 'test-df-eu2' -Name 'test-selfhost-ir' -ResourceGroupName 'rg-test-dfv2'
```
