...
Gets information about activity windows associated with a data factory. (autogenerated)

<!-- Aladdin Generated Example -->
```powershell
Get-AzDataFactoryActivityWindow -DataFactoryName 'WikiADF' -ResourceGroupName 'ADF' -RunStart <DateTime>
```
