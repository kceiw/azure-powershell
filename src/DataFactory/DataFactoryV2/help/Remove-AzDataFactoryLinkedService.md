...
PS C:> Remove-AzDataFactoryLinkedService -DataFactoryName WikiADF -Force  -Name LinkedServiceTest -ResourceGroupName ADF
```

The Remove-AzDataFactoryLinkedService cmdlet removes a linked service from Azure Data Factory. (autogenerated)
