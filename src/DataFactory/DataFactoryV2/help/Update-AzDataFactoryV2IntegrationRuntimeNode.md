...
Update-AzDataFactoryV2IntegrationRuntimeNode -ConcurrentJobsLimit <Int32> -DataFactoryName WikiADF -IntegrationRuntimeName 'test-selfhost-ir' -Name Trigger1 -ResourceGroupName 'rg-test-dfv2'
```
