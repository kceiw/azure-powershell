...
Configures the active period for data slices. (autogenerated)

```powershell <!-- Aladdin Generated Example --> 
Set-AzDataFactoryPipelineActivePeriod -DataFactoryName 'WikiADF' -EndDateTime 2014-05-22T16:00:00Z -ForceRecalculate -PipelineName 'DPWikisample' -ResourceGroupName 'ADF' -StartDateTime 2014-05-21T16:00:00Z
```
