...
PS C:> Set-AzDataFactoryPipelineActivePeriod -AutoResolve  -DataFactoryName WikiADF -EndDateTime 2014-05-22T16:00:00Z -PipelineName DPWikisample -ResourceGroupName ADF -StartDateTime 2014-05-21T16:00:00Z
```

The Set-AzDataFactoryPipelineActivePeriod cmdlet configures the active period for the data slices that are processed by a pipeline in Azure Data Factory (autogenerated)
