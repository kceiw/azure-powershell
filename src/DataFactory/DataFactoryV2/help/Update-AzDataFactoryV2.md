...
PS C:> Update-AzDataFactoryV2 -Name WikiADF -ResourceGroupName ADF
```

The Update-AzDataFactoryV2 cmdlet updates tags or identity properties of a data factory. (autogenerated)
