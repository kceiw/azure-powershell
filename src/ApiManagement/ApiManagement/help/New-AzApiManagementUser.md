...
Registers a new user. (autogenerated)

<!-- Aladdin Generated Example -->
```powershell
New-AzApiManagementUser -Context <PsApiManagementContext> -Email 'Patti.Fuller@contoso.com' -FirstName 'Patti' -LastName 'Fuller' -Note 'Releasing version 6' -Password <SecureString> -State Active
```
