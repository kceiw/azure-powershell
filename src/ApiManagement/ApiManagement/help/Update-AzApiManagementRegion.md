...
PS C:> Update-AzApiManagementRegion -ApiManagement $apimService -Capacity 2 -Location North Central US -Sku Developer -VirtualNetwork $additionalRegionVirtualNetwork
```

The Update-AzApiManagementRegion cmdlet updates an existing instance of type Microsoft.Azure.Commands.ApiManagement.Models.PsApiManagementRegion in a collection of AdditionalRegions objects of a provided instance of type Microsoft.Azure.Commands.ApiManagement.Models.PsApiManagement (autogenerated)
