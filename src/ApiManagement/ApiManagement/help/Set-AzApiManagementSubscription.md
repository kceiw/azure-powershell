...
Sets existing subscription details. (autogenerated)

```powershell <!-- Aladdin Generated Example --> 
Set-AzApiManagementSubscription -Context $apimContext -PrimaryKey '00000000-0000-0000-0000-000000000000' -SecondaryKey '00000000-0000-0000-0000-000000000000' -State Suspended
```
