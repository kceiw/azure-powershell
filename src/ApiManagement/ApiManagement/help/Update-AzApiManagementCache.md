...
PS C:> Update-AzApiManagementCache -CacheId centralus -ConnectionString teamdemo.redis.cache.windows.net:6380,password=xxxxxx+xxxxx=,ssl=True,abortConnect=False -Context $context
```

The cmdlet Update-AzApiManagementCache updates a cache in the ApiManagement service. (autogenerated)
