...
PS C:> Set-AzApiManagementApiVersionSet -ApiVersionSetId $ApiVersionSetId -Context $ApiMgmtContext -Description Create Echo Api V4 -Name ContosoApi -Scheme Segment
```

The Set-AzApiManagementApiVersionSet cmdlet modifies an Azure API Management API Version Set. (autogenerated)
