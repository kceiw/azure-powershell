...
Updates an API Version Set in the API Management Context. (autogenerated)

```powershell <!-- Aladdin Generated Example --> 
Set-AzApiManagementApiVersionSet -ApiVersionSetId 'xmsVersionSet' -Context $ApiMgmtContext -Description 'Create Echo Api V4' -Name 'ContosoApi' -Scheme Segment
```
