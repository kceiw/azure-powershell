...
PS C:> Set-AzApiManagementApiSchema -ApiId echo-api -Context $ApiMgmtContext -PassThru  -SchemaDocument <String> -SchemaDocumentContentType swaggerdefinition -SchemaId 2
```

The Set-AzApiManagementApiSchema cmdlet modifies an Azure API Management API Schema. (autogenerated)
