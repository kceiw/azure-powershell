...
Exports an API to a file. (autogenerated)

<!-- Aladdin Generated Example -->
```powershell
Export-AzApiManagementApi -ApiId '0123456789' -ApiRevision 6 -Context <PsApiManagementContext> -SaveAs 'C:\contoso\specifications\0123456789.wadl' -SpecificationFormat Wadl
```
