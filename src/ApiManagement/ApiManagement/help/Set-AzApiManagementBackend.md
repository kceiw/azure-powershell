...
<!-- Aladdin Generated Example -->
```powershell
Set-AzApiManagementBackend -BackendId 123 -Context <PsApiManagementContext> -Description 'updated description' -Protocol https -Title 'first backend' -Url 'https://contoso.com/awesomeapi'
```
