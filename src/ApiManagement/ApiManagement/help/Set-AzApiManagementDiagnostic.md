...
Set-AzApiManagementDiagnostic -AlwaysLog allErrors -ApiId '0001' -Context $ApiMgmtContext -DiagnosticId 'applicationinsights' -LoggerId 'Logger123' -SamplingSetting $samplingSetting
```
