...
Creates a new Cache entity. (autogenerated)

<!-- Aladdin Generated Example -->
```powershell
New-AzApiManagementCache -AzureRedisResourceId <String> -CacheId westus -ConnectionString 'teamdemo.redis.cache.windows.net:6380,password=xxxxxx+xxxxx=,ssl=$true,abortConnect=$false' -Context <PsApiManagementContext> -Description 'Team Cache'
```
