...
PS C:> New-AzApiManagementApiSchema -ApiId 0001 -Context $ApiMgmtContext -SchemaDocumentContentType swaggerdefinition -SchemaDocumentFilePath C:UserssasolankDownloadspetstoreschema.json
```
