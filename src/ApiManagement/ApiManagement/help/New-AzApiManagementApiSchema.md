...
Creates the new API Schema in the ApiManagement service. (autogenerated)

<!-- Aladdin Generated Example -->
```powershell
New-AzApiManagementApiSchema -ApiId swagger-petstore-extensive -Context <PsApiManagementContext> -SchemaDocument <String> -SchemaDocumentContentType swaggerdefinition -SchemaId 5cc9cf67e6ed3b1154e638bd
```
