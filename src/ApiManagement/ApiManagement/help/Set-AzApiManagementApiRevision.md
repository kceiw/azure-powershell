...
PS C:> Set-AzApiManagementApiRevision -ApiId 0001 -ApiRevision 6 -Context $ApiMgmtContext -Name ContosoApi -Protocols Http -ServiceUrl https://contoso.com/apis/echo
```

The Set-AzApiManagementApiRevision cmdlet modifies an Azure API Management API Revision. (autogenerated)
