...
Modifies an API Revision. (autogenerated)

```powershell <!-- Aladdin Generated Example --> 
Set-AzApiManagementApiRevision -ApiId '0001' -ApiRevision 6 -Context $ApiMgmtContext -Name 'ContosoApi' -Protocols Http -ServiceUrl 'https://contoso.com/apis/echo'
```
