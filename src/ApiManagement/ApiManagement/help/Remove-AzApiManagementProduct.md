...
PS C:> Remove-AzApiManagementProduct -Confirm  -DeleteSubscriptions  -ProductId 0123456789
```

The Remove-AzApiManagementProduct cmdlet removes an existing API Management product. (autogenerated)
