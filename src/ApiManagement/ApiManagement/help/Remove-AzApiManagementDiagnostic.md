...
Remove the Diagnostic entity from Global or API level scope. (autogenerated)

```powershell <!-- Aladdin Generated Example --> 
Remove-AzApiManagementDiagnostic -ResourceId /subscriptions/subid/resourceGroups/Api-Default-West-US/providers/Microsoft.ApiManagement/service/contoso
```
