...
Updates a particular Api Release. (autogenerated)

```powershell <!-- Aladdin Generated Example --> 
Update-AzApiManagementApiRelease -ApiId '0001' -Context $ApiMgmtContext -Note 'Releasing version 6' -ReleaseId 5afccaf6b89fd067426d402e
```
