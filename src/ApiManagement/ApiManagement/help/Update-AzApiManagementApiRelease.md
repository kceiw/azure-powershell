...
PS C:> Update-AzApiManagementApiRelease -ApiId 0001 -Context $ApiMgmtContext -ReleaseId 5afccaf6b89fd067426d402e
```

The Update-AzApiManagementApiRelease cmdlet modifies an Azure API Management API Release. (autogenerated)
