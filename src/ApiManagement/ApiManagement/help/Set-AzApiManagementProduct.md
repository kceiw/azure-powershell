...
Sets the API Management product details. (autogenerated)

```powershell <!-- Aladdin Generated Example --> 
Set-AzApiManagementProduct -ApprovalRequired $true -Context <PsApiManagementContext> -Description 'Starter Product' -ProductId '0123456789' -State NotPublished -SubscriptionRequired $true -SubscriptionsLimit <Int32> -Title 'Starter'
```
