...
PS C:> Remove-AzApiManagementApiFromProduct -ApiId 0001 -Context $ApiMgmtContext -ProductId 0123456789
```

The Remove-AzApiManagementApiFromProduct cmdlet removes an Azure API Management API from a product. (autogenerated)
