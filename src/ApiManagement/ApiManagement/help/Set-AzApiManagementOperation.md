...
<!-- Aladdin Generated Example -->
```powershell
Set-AzApiManagementOperation -ApiId '0001' -Context <PsApiManagementContext> -Method 'GET' -Name 'ContosoApi' -OperationId 'Operation003' -TemplateParameters <PsApiManagementParameter[]> -UrlTemplate '/newresource'
```
