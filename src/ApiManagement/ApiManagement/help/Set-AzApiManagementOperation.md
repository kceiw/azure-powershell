...
PS C:> Set-AzApiManagementOperation -ApiId 0001 -Context $ApiMgmtContext -Method GET -Name ContosoApi -OperationId Operation003 -UrlTemplate /newresource
```

The Set-AzApiManagementOperation cmdlet sets API operation details. (autogenerated)
