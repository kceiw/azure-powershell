...
PS C:> Set-AzApiManagementIdentityProvider -AllowedTenants samirtestbc.onmicrosoft.com -Authority {Authority} -ClientId clientid -ClientSecret updatedSecret -Context $apimContext -PasswordResetPolicyName {PasswordResetPolicyName} -ProfileEditingPolicyName {ProfileEditingPolicyName} -SigninPolicyName {SigninPolicyName} -SignupPolicyName B2C_1_signup-policy -Type Facebook
```
