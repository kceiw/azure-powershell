...
PS C:> Set-AzApiManagementProperty -Context $apimContext -PropertyId Property11 -Value Property Value
```

The Set-AzApiManagementProperty cmdlet modifies an Azure API Management Property. (autogenerated)
