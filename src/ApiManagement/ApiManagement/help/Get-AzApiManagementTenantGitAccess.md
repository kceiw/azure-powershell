...
PS C:> Get-AzApiManagementTenantGitAccess -Context $ApiMgmtContext
```

The Get-AzApiManagementTenantGitAccess cmdlet gets the Git access configuration for a tenant. (autogenerated)
