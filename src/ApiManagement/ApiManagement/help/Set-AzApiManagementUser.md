...
PS C:> Set-AzApiManagementUser -Context $apimContext -Email patti.fuller@contoso.com -FirstName Patti -LastName Fuller -Password $securePassword -State Active -UserId 0123456789
```

The Set-AzApiManagementUser cmdlet sets user details. (autogenerated)
