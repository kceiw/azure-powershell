...
```powershell
New-AzApiManagementIdentityProvider -AllowedTenants 'samirtestbc.onmicrosoft.com' -ClientId 'sdfsfwerwerw' -ClientSecret 'foobar' -Context <PsApiManagementContext> -SigninTenant <String> -Type Facebook
```
