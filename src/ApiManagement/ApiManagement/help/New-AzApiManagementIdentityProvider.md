...
New-AzApiManagementIdentityProvider -AllowedTenants 'samirtestbc.onmicrosoft.com' -Authority <String> -ClientId 'sdfsfwerwerw' -ClientSecret 'foobar' -Context $apimContext -SigninTenant <String> -Type Facebook
```
