...
PS C:> New-AzApiManagementApiVersionSet -Context $ApiMgmtContext -Name Echo API Version Set -Scheme Segment
```

The New-AzApiManagementApiVersionSet cmdlet creates an API Version set entity in the Azure API Management context. (autogenerated)
