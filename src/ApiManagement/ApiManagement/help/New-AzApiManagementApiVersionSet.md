...
Creates an API Version Set. (autogenerated)

<!-- Aladdin Generated Example -->
```powershell
New-AzApiManagementApiVersionSet -ApiVersionSetId 'xmsVersionSet' -Context <PsApiManagementContext> -Description 'version by xmsversion' -HeaderName 'x-ms-version' -Name 'Echo API Version Set' -Scheme Segment
```
