...
PS C:> Suspend-AzPowerBIEmbeddedCapacity -Name testcapacity -ResourceGroupName testRG
```

The Suspend-AzPowerBIEmbeddedCapacity cmdlet suspends an instance of PowerBI Embedded Capacity. (autogenerated)
