...
PS C:> Update-AzPowerBIEmbeddedCapacity -Name testcapacity -ResourceGroupName MyResourceGroup -Sku A1
```

The Update-AzPowerBIEmbeddedCapacity cmdlet modifies an instance of PowerBI Embedded Capacity. (autogenerated)
