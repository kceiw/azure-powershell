...
PS C:> Set-AzStorageSyncServerEndpoint -Name myServerEndpointName -ResourceGroupName myResourceGroup -StorageSyncServiceName myStorageSyncServiceName -SyncGroupName mySyncGroupName
```

This command allows for changes on the adjustable parameters of a server endpoint (autogenerated)
