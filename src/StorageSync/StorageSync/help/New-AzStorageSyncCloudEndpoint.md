...
PS C:> New-AzStorageSyncCloudEndpoint -AzureFileShareName myAzureFileShareName -Name myCloudEndpointName -ParentObject {ParentObject} -StorageAccountResourceId $storageAccountResourceId
```

This command creates an Azure File Sync cloud endpoint (autogenerated)
