...
```powershell
New-AzStorageSyncServerEndpoint -CloudTiering -Name 'myServerEndpointName' -ResourceGroupName 'myResourceGroup' -ServerLocalPath 'myServerLocalPath' -ServerResourceId <String> -StorageSyncServiceName 'myStorageSyncServiceName' -SyncGroupName 'mySyncGroupName' -VolumeFreeSpacePercent <Int32>
```
