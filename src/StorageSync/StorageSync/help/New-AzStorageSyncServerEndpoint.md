...
This command creates a new server endpoint on a registered server. (autogenerated)

<!-- Aladdin Generated Example -->
```powershell
New-AzStorageSyncServerEndpoint -CloudTiering -Name 'myServerEndpointName' -ResourceGroupName 'myResourceGroup' -ServerLocalPath 'myServerLocalPath' -ServerResourceId <String> -StorageSyncServiceName 'myStorageSyncServiceName' -SyncGroupName 'mySyncGroupName' -TierFilesOlderThanDays 'myTierFilesOlderThanDays' -VolumeFreeSpacePercent <Int32>
```
