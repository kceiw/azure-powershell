...
PS C:> New-AzStorageSyncServerEndpoint -CloudTiering  -Name myServerEndpointName -ParentObject {ParentObject} -ServerLocalPath myServerLocalPath -ServerResourceId $RegisteredServer.ResourceId -VolumeFreeSpacePercent {VolumeFreeSpacePercent}
```
