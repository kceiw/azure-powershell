...
Update-AzCosmosDBMongoDBDatabaseThroughput [-Name <String>] [-Throughput <Int32>]
 [-AutoscaleMaxThroughput <Int32>] -ParentObject <PSDatabaseAccountGetResults>
...
```
Update-AzCosmosDBMongoDBDatabaseThroughput [-Name <String>] [-Throughput <Int32>]
 [-AutoscaleMaxThroughput <Int32>] -InputObject <PSMongoDBDatabaseGetResults>
 [-DefaultProfile <IAzureContextContainer>] [-WhatIf] [-Confirm] [<CommonParameters>]
```
...
Updates the throughput value of a CosmosDB MongoDB Database. (autogenerated)

<!-- Aladdin Generated Example -->
```powershell
Update-AzCosmosDBMongoDBDatabaseThroughput -AccountName myAccountName -Name dbname -ResourceGroupName myresourcegroup -Throughput 600
```
