...
Updates the CosmosDB Sql Container. (autogenerated)

<!-- Aladdin Generated Example -->
```powershell
Update-AzCosmosDBSqlContainer -AccountName myAccountName -DatabaseName myDatabaseName -Name dbname -ResourceGroupName myresourcegroup -TtlInSeconds <Int32>
```
