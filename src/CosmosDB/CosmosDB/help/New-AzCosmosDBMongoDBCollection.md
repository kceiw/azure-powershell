...
Creates a new CosmosDB MongoDB Collection. (autogenerated)

<!-- Aladdin Generated Example -->
```powershell
New-AzCosmosDBMongoDBCollection -AccountName myAccountName -DatabaseName myDatabaseName -Index <PSMongoIndex[]> -Name myCollectionName -ResourceGroupName myRgName -Throughput 700
```
