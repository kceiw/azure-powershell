...
Updates the throughput value of a CosmosDB Sql Database. (autogenerated)

<!-- Aladdin Generated Example -->
```powershell
Update-AzCosmosDBSqlDatabaseThroughput -AccountName myAccountName -Name dbname -ResourceGroupName myresourcegroup -Throughput 600
```
