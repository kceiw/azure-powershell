...
Creates a new CosmosDB Gremlin Graph. (autogenerated)

<!-- Aladdin Generated Example -->
```powershell
New-AzCosmosDBGremlinGraph -Name myContainerName -ParentObject <PSGremlinDatabaseGetResults> -PartitionKeyKind Hash -PartitionKeyPath /a -Throughput 700
```
