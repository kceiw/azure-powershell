...
Creates a new CosmosDB MongoDB Database. (autogenerated)

<!-- Aladdin Generated Example -->
```powershell
New-AzCosmosDBMongoDBDatabase -AccountName myAccountName -Name myDatabaseName -ResourceGroupName myResourcegroupName -Throughput 700
```
