...
Updates the CosmosDB MongoDB Collection. (autogenerated)

<!-- Aladdin Generated Example -->
```powershell
Update-AzCosmosDBMongoDBCollection -AccountName myAccountName -DatabaseName myDatabaseName -Index <PSMongoIndex[]> -Name myCollectionName -ResourceGroupName myRgName -Throughput 600
```
