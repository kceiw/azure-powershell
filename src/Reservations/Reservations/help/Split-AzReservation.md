...
Split a Reservation. (autogenerated)

<!-- Aladdin Generated Example -->
```powershell
Split-AzReservation -Quantity 2 -ReservationId '00000000-0000-0000-0000-000000000000111' -ReservationOrderId '00000000-0000-0000-0000-000000000000fff'
```
