...
Purchase a reservation. (autogenerated)

<!-- Aladdin Generated Example -->
```powershell
New-AzReservation -AppliedScopeType 'Shared' -BillingPlan <String> -BillingScopeId '/subscriptions/00000000-0000-0000-0000-00000000000000000' -DisplayName <String> -Location 'centralus' -Quantity 2 -ReservationOrderId '00000000-0000-0000-0000-00000000000000000' -ReservedResourceType 'VirtualMachines' -Sku <String> -Term 'P1Y'
```
