...
Creates or updates the policy for a certificate in a key vault. (autogenerated)

<!-- Aladdin Generated Example -->
```powershell
Set-AzKeyVaultCertificatePolicy -DnsName 'contoso.com' -IssuerName 'Self' -Name 'TestCert01' -RenewAtPercentageLifetime <Int32> -SecretContentType application/x-pkcs12 -SubjectName 'CN=contoso.com' -ValidityInMonths 6 -VaultName 'ContosoKV01' -InputObject <PSKeyVaultCertificatePolicy>
```
