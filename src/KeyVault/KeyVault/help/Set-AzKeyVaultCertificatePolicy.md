...
PS C:> Set-AzKeyVaultCertificatePolicy -Name TestCert01 -RenewAtNumberOfDaysBeforeExpiry <Int32> -ValidityInMonths 6 -VaultName ContosoKV01
```

The Set-AzKeyVaultCertificatePolicy cmdlet creates or updates the policy for a certificate in a key vault. (autogenerated)
