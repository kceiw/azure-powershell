...
PS C:> Update-AzKeyVaultKey -Name ITSoftware -VaultName Contoso
```

The Update-AzKeyVaultKey cmdlet updates the editable attributes of a key in a key vault. (autogenerated)
