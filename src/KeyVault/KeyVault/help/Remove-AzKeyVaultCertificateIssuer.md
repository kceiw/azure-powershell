...
PS C:> Remove-AzKeyVaultCertificateIssuer -Name TestIssuer01 -VaultName ContosoKV01
```

The Remove-AzKeyVaultCertificateIssuer cmdlet deletes a certificate issuer from a key vault. (autogenerated)
