...
PS C:> Remove-AzKeyVaultCertificate -Confirm  -Force  -Name MyCert -VaultName Contoso
```

The Remove-AzKeyVaultCertificate cmdlet removes a certificate from a key vault. (autogenerated)
