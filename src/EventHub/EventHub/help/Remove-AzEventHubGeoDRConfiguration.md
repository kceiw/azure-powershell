...
PS C:> Remove-AzEventHubGeoDRConfiguration -InputObject $inputobject
```

The Remove-AzEventHubGeoDRConfiguration cmdlet deletes an Alias(Disaster Recovery configuration). (autogenerated)
