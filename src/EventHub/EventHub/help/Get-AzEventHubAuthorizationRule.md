...
### Example 1: 1.0 - AuthorizationRule for namespace
```powershell
...
### Example 2: 1.1 - AuthorizationRules for namespace
```powershell
...
### Example 3: 2.0 - AuthorizationRule for EventHub
```powershell
...
### Example 4: 2.1 - AuthorizationRules for EventHub
```powershell
PS C:\> Get-AzEventHubAuthorizationRule -ResourceGroupName MyResourceGroupName -NamespaceName MyNamespaceName -EventHubName MyEventHubName
```
...
### Example 5: 3.0 - AuthorizationRule for Alias (GeoRecovery Configuration)
```powershell
...
### Example 6: 3.1 -AuthorizationRules for Alias (GeoRecovery Configuration)
```powershell
