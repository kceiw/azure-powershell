...
New-AzEventHubAuthorizationRule -EventHub MyEventHubName -Name MyAuthRuleName -Namespace MyNamespaceName -ResourceGroupName MyResourceGroupName -Rights Listen
```
