...
Create a budget in either a subscription or a resource group. (autogenerated)

<!-- Aladdin Generated Example -->
```powershell
New-AzConsumptionBudget -Amount 60 -Category Cost -ContactEmail johndoe@contoso.com,janesmith@contoso.com -EndDate 2018-11-01 -Name PSBudget -NotificationEnabled -NotificationKey notificationKey-ps1234 -NotificationThreshold 90 -ResourceGroupName RGBudgets -StartDate 2018-06-01 -TimeGrain Monthly
```
