...
```powershell
New-AzConsumptionBudget -Amount 60 -Category Cost -ContactEmail johndoe@contoso.com,janesmith@contoso.com -ContactGroup <String[]> -EndDate 2018-11-01 -Name PSBudget -NotificationEnabled -NotificationKey notificationKey-ps1234 -NotificationThreshold 90 -StartDate 2018-06-01 -TimeGrain Monthly
```
