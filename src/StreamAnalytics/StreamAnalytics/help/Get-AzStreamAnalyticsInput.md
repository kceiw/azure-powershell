...
## DESCRIPTION
The **Get-AzStreamAnalyticsInput** cmdlet lists all of the inputs that are defined in a Stream Analytics job or gets information about a specific input.

## EXAMPLES

### Example 1: EXAMPLE 1: Get information about the inputs defined on a job
```powershell
...
### Example 2: EXAMPLE 2: Get information about a specific input defined on a job
```powershell
