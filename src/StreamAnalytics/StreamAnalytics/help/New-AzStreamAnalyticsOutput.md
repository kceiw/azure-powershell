...
### Example 1: EXAMPLE 1: Add an output to a job
```powershell
...
### Example 2: EXAMPLE 2: Replace a job output definition
```powershell
...
The New-AzStreamAnalyticsOutput cmdlet creates an output within a Stream Analytics job or updates an existing output (autogenerated)
