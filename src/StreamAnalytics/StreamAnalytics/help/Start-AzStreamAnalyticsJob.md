...
### Example 1: EXAMPLE 1: Start a Stream Analytics job
```powershell
...
The Start-AzStreamAnalyticsJob cmdlet asynchronously deploys and starts a Stream Analytics job in Azure. (autogenerated)
