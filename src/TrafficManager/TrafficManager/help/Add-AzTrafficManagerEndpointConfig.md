...
```powershell
Add-AzTrafficManagerEndpointConfig -EndpointName 'contoso' -EndpointStatus Enabled -TargetResourceId '/subscriptions/00000000-0000-0000-0000-00000000000000000/resourceGroups/Default-Web-CentralUS/providers/Microsoft.Web/sites/contoso-web-app' -TrafficManagerProfile <TrafficManagerProfile> -Type ExternalEndpoints
```
