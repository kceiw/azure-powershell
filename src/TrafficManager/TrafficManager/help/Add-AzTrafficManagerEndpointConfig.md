...
Adds an endpoint to a local Traffic Manager profile object. (autogenerated)

<!-- Aladdin Generated Example -->
```powershell
Add-AzTrafficManagerEndpointConfig -EndpointLocation 'North Europe' -EndpointName 'contoso' -EndpointStatus Enabled -Priority 1 -TargetResourceId '/subscriptions/00000000-0000-0000-0000-00000000000000000/resourceGroups/Default-Web-CentralUS/providers/Microsoft.Web/sites/contoso-web-app' -TrafficManagerProfile <TrafficManagerProfile> -Type ExternalEndpoints -Weight 10
```
