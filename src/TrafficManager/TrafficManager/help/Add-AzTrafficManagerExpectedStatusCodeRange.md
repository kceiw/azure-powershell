...
PS C:> Add-AzTrafficManagerExpectedStatusCodeRange -Max 499 -Min 200
```

The Add-AzTrafficManagerExpectedStatusCodeRange cmdlet adds a range of expected status codes to a local Azure Traffic Manager profile object (autogenerated)
