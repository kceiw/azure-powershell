...
Creates a in memory PSObject to be used for creating or modifying a Peering. (autogenerated)

<!-- Aladdin Generated Example -->
```powershell
New-AzPeeringExchangeConnectionObject -MaxPrefixesAdvertisedIPv4 20000 -MaxPrefixesAdvertisedIPv6 2000 -PeerSessionIPv4Address 10.3.151.99 -PeerSessionIPv6Address <String> -PeeringDBFacilityId 99999
```
