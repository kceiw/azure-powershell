...
PS C:> Get-AzRecoveryServicesAsrServicesProvider -Fabric $Fabric
```

The Get-AzRecoveryServicesAsrServicesProvider cmdlet gets information on the Azure Site Recovery providers in the vault. (autogenerated)
