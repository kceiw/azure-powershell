...
Gets the items from a container in Backup. (autogenerated)

<!-- Aladdin Generated Example -->
```powershell
Get-AzRecoveryServicesBackupItem -BackupManagementType 'AzureVM' -Name 'MSSQLSERVER;model' -WorkloadType 'AzureVM'
```
