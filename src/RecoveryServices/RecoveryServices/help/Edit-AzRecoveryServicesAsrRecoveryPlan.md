...
PS C:> Edit-AzRecoveryServicesAsrRecoveryPlan -AddProtectedItem <ASRReplicationProtectedItem[]> -Group <ASRRecoveryPlanGroup>
```

The Edit-AzRecoveryServicesAsrRecoveryPlan cmdlet edits an Azure Site Recovery plan. (autogenerated)
