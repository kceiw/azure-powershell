...
PS C:> Set-AzRecoveryServicesAsrReplicationProtectedItem -InputObject $RPI -RecoveryBootDiagStorageAccountId {RecoveryBootDiagStorageAccountId}
```

The Set-AzRecoveryServicesAsrReplicationProtectedItem cmdlet sets the recovery properties for a Replication Protected Item. (autogenerated)
