...
PS C:> Start-AzRecoveryServicesAsrPlannedFailoverJob -CreateVmIfNotFound Yes -Direction PrimaryToRecovery -RecoveryPlan $RP
```

The Start-AzRecoveryServicesAsrPlannedFailoverJob cmdlet starts a planned failover for an Azure Site Recovery replication protected item or recovery plan (autogenerated)
