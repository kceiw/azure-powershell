...
PS C:> Search-AzGraph -First 3 -Query summarize count() by tenantDisplayName, subscriptionDisplayName -Subscription {Subscription}
```

Learn more about the query syntax here: https://aka.ms/resource-graph/learntoquery. (autogenerated)
