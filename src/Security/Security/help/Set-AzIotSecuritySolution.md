...
Create or update IoT security solution. (autogenerated)

<!-- Aladdin Generated Example -->
```powershell
Set-AzIotSecuritySolution -DisplayName 'MySample' -Enabled $true -Export <String[]> -IotHub <String[]> -Location 'West US' -Name 'MySample' -ResourceGroupName 'MyResourceGroup' -UnmaskedIpLoggingStatus <String> -Workspace <String>
```
