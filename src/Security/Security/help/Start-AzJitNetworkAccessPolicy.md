...
Opens up a network connection according to the specified connection request data. (autogenerated)

<!-- Aladdin Generated Example -->
```powershell
Start-AzJitNetworkAccessPolicy -Location westus -Name 'IoT_SucessfulLocalLogin/2020-03-15' -ResourceGroupName myresourcegroup -VirtualMachine <PSSecurityJitNetworkAccessPolicyInitiateVirtualMachine[]>
```
