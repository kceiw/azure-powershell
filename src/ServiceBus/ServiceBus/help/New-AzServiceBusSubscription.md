...
Creates a subscription to the specified Service Bus topic. (autogenerated)

<!-- Aladdin Generated Example -->
```powershell
New-AzServiceBusSubscription -MaxDeliveryCount <Int32> -Name SB-TopicSubscription-Example1 -Namespace SB-Example1 -ResourceGroupName Default-ServiceBus-WestUS -Topic SB-Topic_exampl1
```
