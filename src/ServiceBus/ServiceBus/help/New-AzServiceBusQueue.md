...
```powershell
New-AzServiceBusQueue -EnablePartitioning $true -MaxDeliveryCount <Int32> -MaxSizeInMegabytes <Int64> -Name SB-Queue_example1 -Namespace SB-Example1 -ResourceGroupName Default-ServiceBus-WestUS
```
