...
PS C:> Remove-AzServiceBusIPRule -IpMask 11.22.33.44 -Name ServiceBus-Namespace1-2389 -ResourceGroupName v-ajnavtest
```

Remove a single IP rule to the NetworkRuleSet of the given Namespace. (autogenerated)
