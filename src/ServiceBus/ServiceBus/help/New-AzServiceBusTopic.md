...
New-AzServiceBusTopic -EnablePartitioning <Boolean> -MaxSizeInMegabytes <Int64> -Name SB-Topic_exampl1 -Namespace SB-Example1 -ResourceGroupName Default-ServiceBus-WestUS
```
