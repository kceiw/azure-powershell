...
PS C:> Start-AzHDInsightJob -ClusterName $clusterName -HttpCredential $clusterCreds -JobDefinition {JobDefinition}
```

The Start-AzHDInsightJob cmdlet starts a defined Azure HDInsight job on a specified cluster (autogenerated)
