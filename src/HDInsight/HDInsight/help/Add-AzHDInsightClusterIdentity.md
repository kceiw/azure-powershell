...
PS C:> Add-AzHDInsightClusterIdentity -AadTenantId {AadTenantId} -CertificateFileContents {CertificateFileContents} -CertificatePassword {CertificatePassword} -ObjectId {ObjectId}
```

The Add-AzHDInsightClusterIdentity cmdlet adds a cluster identity to the Azure HDInsight configuration object created by the New-AzHDInsightClusterConfig cmdlet. (autogenerated)
