...
Modifies  an instance of Analysis Services server. (autogenerated)

<!-- Aladdin Generated Example -->
```powershell
Set-AzAnalysisServicesServer -FirewallConfig <PsAzureAnalysisServicesFirewallConfig> -Name 'testserver' -PassThru -ResourceGroupName 'testgroup'
```
