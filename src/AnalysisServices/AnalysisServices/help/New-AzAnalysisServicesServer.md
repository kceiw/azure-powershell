...
```powershell
New-AzAnalysisServicesServer -Administrator 'testuser1@contoso.com' -DefaultConnectionMode All -FirewallConfig <PsAzureAnalysisServicesFirewallConfig> -Location 'West-US' -Name 'testserver' -ResourceGroupName 'testresourcegroup' -Sku 'S1' -Tag 'key1:value1,key2:value2'
```
