...
Deletes a data source. (autogenerated)

<!-- Aladdin Generated Example -->
```powershell
Remove-AzOperationalInsightsDataSource -Name 'MyStorageInsight' -ResourceGroupName myresourcegroup -WorkspaceName <String>
```
