...
PS C:> Set-AzOperationalInsightsStorageInsight -Containers @(wad-iis-logfiles) -Name MyStorageInsight -ResourceGroupName ContosoResourceGroup -StorageAccountKey $StorageKey -Tables @(WADWindowsEventLogsTable) -WorkspaceName MyWorkspace
```

The Set-AzOperationalInsightsStorageInsight cmdlet changes the configuration of a Storage Insight. (autogenerated)
