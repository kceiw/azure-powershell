...
PS C:> Enable-AzOperationalInsightsLinuxCustomLogCollection -ResourceGroupName MyResourceGroup -WorkspaceName ContosoWorkspace
```

The Enable-AzOperationalInsightsLinuxCustomLogCollection cmdlet starts collection of custom logs from connected Linux computers in a workspace. (autogenerated)
