...
The Enable-AzOperationalInsightsLinuxSyslogCollection cmdlet starts collection of syslog data from connected Linux computers in a workspace. (autogenerated)
