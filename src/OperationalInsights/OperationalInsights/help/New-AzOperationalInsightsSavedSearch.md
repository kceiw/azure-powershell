...
Creates a new saved search with the specified parameters. (autogenerated)

<!-- Aladdin Generated Example -->
```powershell
New-AzOperationalInsightsSavedSearch -Category 'ContosoSavedSearchCategory' -DisplayName 'ContosoSavedSearchDisplayName' -FunctionAlias <String> -Query '*' -ResourceGroupName 'ContosoResourceGroup' -SavedSearchId 'ContosoSavedSearchId' -WorkspaceName 'ContosoWorkspace'
```
