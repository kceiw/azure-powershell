...
The Get-AzAutomationRegistrationInfo cmdlet gets the endpoint and keys required to onboard a Desired State Configuration (DSC) node or hybrid worker into an Azure Automation account. (autogenerated)
