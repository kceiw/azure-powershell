...
PS C:> Get-AzAutomationSoftwareUpdateMachineRun -AutomationAccountName AutomationAccount01 -ResourceGroupName mygroup
```

This cmdlet returns a list of machine runs (autogenerated)
