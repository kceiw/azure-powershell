...
PS C:> Set-AzAutomationRunbook -AutomationAccountName Contoso17 -LogProgress False -Name Runbook02 -ResourceGroupName ResourceGroup01
```

The Set-AzAutomationRunbook cmdlet modifies the configuration of an Azure Automation runbook in APS. (autogenerated)
