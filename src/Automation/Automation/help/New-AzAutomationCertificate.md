...
Creates an Automation certificate. (autogenerated)

<!-- Aladdin Generated Example -->
```powershell
New-AzAutomationCertificate -AutomationAccountName 'Contoso17' -Exportable -Name 'ContosoCertificate' -Password <SecureString> -Path './cert.pfx' -ResourceGroupName 'ResourceGroup01'
```
