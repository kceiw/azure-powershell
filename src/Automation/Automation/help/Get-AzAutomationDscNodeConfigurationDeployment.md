...
PS C:> Get-AzAutomationDscNodeConfigurationDeployment -AutomationAccountName AutomationAccount01 -ResourceGroupName MyResourceGroup
```

The Get-AzAutomationDscNodeConfigurationDeployment cmdlet deploys an APS Desired State Configuration (DSC) node configuration in Azure Automation. (autogenerated)
