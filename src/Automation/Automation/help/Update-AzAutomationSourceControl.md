...
PS C:> Update-AzAutomationSourceControl -AutomationAccountName AutomationAccount01 -Branch {Branch} -Name Configuration01 -ResourceGroupName rg1
```

The Update-AzAutomationSourceControl cmdlet modifies the value of a field in a source control in Azure Automation. (autogenerated)
