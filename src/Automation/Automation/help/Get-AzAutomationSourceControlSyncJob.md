...
PS C:> Get-AzAutomationSourceControlSyncJob -AutomationAccountName AutomationAccount01 -JobId 00000000-0000-0000-0000-000000000000 -ResourceGroupName rg1 -SourceControlName <String>
```

The Get-AzAutomationSourceControlSyncJob cmdlet gets Azure Automation source control sync jobs (autogenerated)
