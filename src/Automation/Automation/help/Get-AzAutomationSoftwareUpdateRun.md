...
PS C:> Get-AzAutomationSoftwareUpdateRun -AutomationAccountName AutomationAccount01 -ResourceGroupName mygroup -StartTime $StartTime
```

The Get-AzAutomationSoftwareUpdateRun cmdlet returns a list of software update runs (autogenerated)
