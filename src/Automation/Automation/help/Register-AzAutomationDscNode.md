...
Registers an Azure virtual machine running Windows OS as a DSC node for an Automation account. (autogenerated)

<!-- Aladdin Generated Example -->
```powershell
Register-AzAutomationDscNode -AutomationAccountName 'Contoso17' -AzureVMName 'VirtualMachine01' -AzureVMResourceGroup <String> -NodeConfigurationName 'ContosoConfiguration.webserver' -ResourceGroupName 'ResourceGroup01'
```
