...
PS C:> Register-AzAutomationDscNode -AutomationAccountName Contoso17 -AzureVMName VirtualMachine01 -AzureVMResourceGroup {AzureVMResourceGroup} -ConfigurationModeFrequencyMins {ConfigurationModeFrequencyMins} -NodeConfigurationName ContosoConfiguration.webserver -ResourceGroupName ResourceGroup01-NodeConfigurationName
```
