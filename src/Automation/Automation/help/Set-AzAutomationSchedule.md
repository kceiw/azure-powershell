...
Modifies an Automation schedule. (autogenerated)

<!-- Aladdin Generated Example -->
```powershell
Set-AzAutomationSchedule -AutomationAccountName 'Contoso17' -IsEnabled $true -Name 'Schedule01' -ResourceGroupName 'ResourceGroup01'
```
