...
Removes an association between a runbook and a schedule. (autogenerated)

<!-- Aladdin Generated Example -->
```powershell
Unregister-AzAutomationScheduledRunbook -AutomationAccountName 'Contoso17' -JobScheduleId 00000000-0000-0000-0000-00000000000000000 -ResourceGroupName 'ResourceGroup01'
```
