...
Creates a scheduled azure automation software update configuration. (autogenerated)

<!-- Aladdin Generated Example -->
```powershell
New-AzAutomationSoftwareUpdateConfiguration -AutomationAccountName 'myaccount' -AzureQuery <AzureQueryProperties[]> -Duration <TimeSpan> -IncludedUpdateClassification Unclassified -RebootSetting IfRequired -ResourceGroupName 'mygroup' -Schedule <Schedule> -Windows
```
