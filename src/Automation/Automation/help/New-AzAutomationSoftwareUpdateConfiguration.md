...
PS C:> New-AzAutomationSoftwareUpdateConfiguration -AutomationAccountName myaccount -AzureVMResourceId <String> -Duration {Duration} -IncludedKbNumber {IncludedKbNumber} -ResourceGroupName mygroup -Schedule <Schedule> -Windows 
```

Creates a software update configuration that runs on a schedule to update a list of computers (autogenerated)
