...
```powershell
New-AzAutomationSoftwareUpdateConfiguration -AutomationAccountName 'myaccount' -AzureQuery <AzureQueryProperties[]> -Duration <TimeSpan> -IncludedUpdateClassification Unclassified -ResourceGroupName 'mygroup' -Schedule <Schedule> -Windows
```
