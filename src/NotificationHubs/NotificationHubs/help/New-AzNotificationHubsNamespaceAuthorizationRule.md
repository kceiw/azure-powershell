...
PS C:> New-AzNotificationHubsNamespaceAuthorizationRule -InputFile C:\Configurations\InternalHub.json -Namespace ContosoNamespace -ResourceGroup ContosoNotificationsGroup
```
