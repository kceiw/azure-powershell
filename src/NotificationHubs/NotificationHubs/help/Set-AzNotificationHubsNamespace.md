...
Sets property values for a notification hub namespace. (autogenerated)

<!-- Aladdin Generated Example -->
```powershell
Set-AzNotificationHubsNamespace -Location 'West US' -Namespace 'ContosoPartners' -ResourceGroup 'ContosoNotificationsGroup' -SkuTier <String> -State Unknown
```
