...
PS C:> Set-AzNotificationHubsNamespace -Force  -Location West US -Namespace ContosoPartners -ResourceGroup ContosoNotificationsGroup -SkuTier {SkuTier}
```

The Set-AzNotificationHubsNamespace cmdlet sets the property values of an existing notification hub namespace (autogenerated)
