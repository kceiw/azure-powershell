...
PS C:> Set-AzNotificationHub -Confirm  -Namespace ContosoNamespace -NotificationHubObj {NotificationHubObj} -ResourceGroup ContosoNotificationsGroup
```

The Set-AzNotificationHub cmdlet modifies the property values of a notification hub (autogenerated)
