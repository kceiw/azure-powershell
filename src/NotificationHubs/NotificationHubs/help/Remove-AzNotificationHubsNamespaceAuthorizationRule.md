...
PS C:> Remove-AzNotificationHubsNamespaceAuthorizationRule -AuthorizationRule ListenRule -Force  -Namespace ContosoNamespace -ResourceGroup ContosoNotificationsGroup
```

The Remove-AzNotificationHubsNamespaceAuthorizationRule cmdlet removes a Shared Access Signature (SAS) authorization rule from a notification hub namespace (autogenerated)
