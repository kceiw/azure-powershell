...
Creates a notification hub namespace. (autogenerated)

<!-- Aladdin Generated Example -->
```powershell
New-AzNotificationHubsNamespace -Location 'West US' -Namespace 'ContosoPartners' -ResourceGroup 'ContosoNotificationsGroup' -SkuTier <String>
```
