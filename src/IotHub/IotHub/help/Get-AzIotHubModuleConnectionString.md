...
Get the connection string of a target IoT device module in an Iot Hub. (autogenerated)

<!-- Aladdin Generated Example -->
```powershell
Get-AzIotHubModuleConnectionString -DeviceId 'myDevice1' -IotHubName 'myiothub' -ModuleId 'myModule1' -ResourceGroupName 'myresourcegroup'
```
