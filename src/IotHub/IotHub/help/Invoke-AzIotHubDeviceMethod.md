...
Invoke a direct method on a device. (autogenerated)

<!-- Aladdin Generated Example -->
```powershell
Invoke-AzIotHubDeviceMethod -ConnectionTimeOut 15 -DeviceId 'myDevice1' -IotHubName 'myiothub' -Name 'methodName' -Payload 'method-input' -ResourceGroupName 'myresourcegroup' -ResponseTimeOut 20
```
...
### -Name
The name of the method to invoke on this device.
...
### -Payload
The payload for the method to invoke on this device.
