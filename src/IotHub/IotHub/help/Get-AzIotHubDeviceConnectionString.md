...
Get the connection string of a target IoT device in an Iot Hub. (autogenerated)

<!-- Aladdin Generated Example -->
```powershell
Get-AzIotHubDeviceConnectionString -DeviceId 'myDevice1' -IotHubName 'myiothub' -ResourceGroupName 'myresourcegroup'
```
