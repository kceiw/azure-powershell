...
PS C:> Add-AzIotHubRoute -Condition {Condition} -Enabled  -EndpointName E1 -Name myiothub -ResourceGroupName myresourcegroup -RouteName R1 -Source Invalid
```

Create a route to send specific data source and condition to a desired endpoint. (autogenerated)
