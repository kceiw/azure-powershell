...
Create a route in IoT Hub. (autogenerated)

<!-- Aladdin Generated Example -->
```powershell
Add-AzIotHubRoute -Condition <String> -Enabled -EndpointName E1 -Name 'myiothub' -ResourceGroupName 'myresourcegroup' -RouteName R1 -Source Invalid
```
