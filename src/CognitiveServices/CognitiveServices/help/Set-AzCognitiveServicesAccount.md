...
Modifies an account. (autogenerated)

<!-- Aladdin Generated Example -->
```powershell
Set-AzCognitiveServicesAccount -KeyName Key1 -KeyVaultUri <String> -KeyVersion <String> -Name myluis -ResourceGroupName cognitive-services-resource-group
```
