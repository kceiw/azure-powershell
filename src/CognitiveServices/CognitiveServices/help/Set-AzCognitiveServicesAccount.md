...
PS C:> Set-AzCognitiveServicesAccount -Name myaccount -NetworkRuleSet {NetworkRuleSet} -ResourceGroupName cognitive-services-resource-group
```

The Set-AzCognitiveServicesAccount cmdlet modifies the SKU or tags of the specified Cognitive Services account. (autogenerated)
