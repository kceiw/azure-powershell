...
PS C:> Remove-AzCognitiveServicesAccount -Force  -Name myaccount -ResourceGroupName cognitive-services-resource-group
```

The Remove-AzCognitiveServicesAccount cmdlet deletes the specified Cognitive Services account. (autogenerated)
