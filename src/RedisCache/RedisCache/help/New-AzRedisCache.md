...
PS C:> New-AzRedisCache -Location North Central US -Name MyCache -ResourceGroupName MyGroup -Size 250MB -Sku Basic
```

The New-AzRedisCache cmdlet creates an Azure Redis Cache. (autogenerated)
