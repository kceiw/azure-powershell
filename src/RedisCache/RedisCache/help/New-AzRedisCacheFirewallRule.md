...
PS C:> New-AzRedisCacheFirewallRule -EndIP 10.0.0.32 -Name mycache -ResourceGroupName MyResourceGroup -RuleName ruleone -StartIP 10.0.0.1
```

Create a firewall rule on a Redis Cache. (autogenerated)
