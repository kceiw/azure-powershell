...
PS C:> New-AzRedisCacheLink -PrimaryServerName mycache1 -SecondaryServerName mycache2 -WhatIf 
```

Create a geo replication link between two Redis Caches. (autogenerated)
